...
### mensual mean
jan.ts.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
fev.ts.stack <- raster::stack(list.nf, bands = 2) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
mar.ts.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
avr.ts.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
may.ts.stack <- raster::stack(list.nf, bands = 5) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jun.ts.stack <- raster::stack(list.nf, bands = 6) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jul.ts.stack <- raster::stack(list.nf, bands = 7) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
agu.ts.stack <- raster::stack(list.nf, bands = 8) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
sep.ts.stack <- raster::stack(list.nf, bands = 9) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
oct.ts.stack <- raster::stack(list.nf, bands = 10) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
nov.ts.stack <- raster::stack(list.nf, bands = 11) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
dec.ts.stack <- raster::stack(list.nf, bands = 12) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
### mensual mean
jan.rsds.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
fev.rsds.stack <- raster::stack(list.nf, bands = 2) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
avr.rsds.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
may.rsds.stack <- raster::stack(list.nf, bands = 5) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jun.rsds.stack <- raster::stack(list.nf, bands = 6) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jul.rsds.stack <- raster::stack(list.nf, bands = 7) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
agu.rsds.stack <- raster::stack(list.nf, bands = 8) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
sep.rsds.stack <- raster::stack(list.nf, bands = 9) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
oct.rsds.stack <- raster::stack(list.nf, bands = 10) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
nov.rsds.stack <- raster::stack(list.nf, bands = 11) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
dec.rsds.stack <- raster::stack(list.nf, bands = 12) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
### mensual mean
jan.sfcWind.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
fev.sfcWind.stack <- raster::stack(list.nf, bands = 2) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
avr.sfcWind.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
may.sfcWind.stack <- raster::stack(list.nf, bands = 5) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jun.sfcWind.stack <- raster::stack(list.nf, bands = 6) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
jul.sfcWind.stack <- raster::stack(list.nf, bands = 7) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
agu.sfcWind.stack <- raster::stack(list.nf, bands = 8) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
sep.sfcWind.stack <- raster::stack(list.nf, bands = 9) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
oct.sfcWind.stack <- raster::stack(list.nf, bands = 10) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
nov.sfcWind.stack <- raster::stack(list.nf, bands = 11) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
...
dec.sfcWind.stack <- raster::stack(list.nf, bands = 12) %>% raster::mean(na.rm = T) %>% projectRaster(cmcc)
