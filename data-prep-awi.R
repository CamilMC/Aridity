...
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/awi.hist.1850-1880.fev.ts.txt")
...
write.table(jun.ts.df.ts.df, file = "/bettik/crapartc/Averages/ts/awi.hist.1850-1880.jun.ts.txt")
...
mar.ts.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/awi.hist.1985-2015.fev.ts.txt")
...
pr.df <- as.data.frame(pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(pr.df, file = "/bettik/crapartc/Averages/pr/awi.hist.1850-1880.pr.txt")

ggplot(pr.df)+geom_raster(aes(x=lon, y = lat, fill = temp_k))

### mensual mean
jan.pr.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T)
jan.pr.df <- as.data.frame(jan.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
fev.pr.df <- as.data.frame(fev.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.hist.1850-1880.fev.pr.txt")

avr.pr.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T)
avr.pr.df <- as.data.frame(avr.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
may.pr.df <- as.data.frame(may.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
jun.pr.df <- as.data.frame(jun.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
jul.pr.df <- as.data.frame(jul.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
agu.pr.df <- as.data.frame(agu.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
sep.pr.df <- as.data.frame(sep.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
oct.pr.df <- as.data.frame(oct.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
nov.pr.df <- as.data.frame(nov.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
dec.pr.df <- as.data.frame(dec.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.hist.1985-2015.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.fev.pr.txt")
...
rsds.df <- as.data.frame(rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.rsds.txt")

ggplot(rsds.df)+geom_raster(aes(x=lon, y = lat, fill = temp_k))

### mensual mean
jan.rsds.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T)
jan.rsds.df <- as.data.frame(jan.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(jan.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.jan.rsds.txt")

fev.rsds.stack <- raster::stack(list.nf, bands = 2) %>% raster::mean(na.rm = T)
fev.rsds.df <- as.data.frame(fev.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(fev.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.fev.rsds.txt")

mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.fev.rsds.txt")

avr.rsds.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T)
avr.rsds.df <- as.data.frame(avr.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(avr.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.avr.rsds.txt")

may.rsds.stack <- raster::stack(list.nf, bands = 5) %>% raster::mean(na.rm = T)
may.rsds.df <- as.data.frame(may.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(may.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.may.rsds.txt")

jun.rsds.stack <- raster::stack(list.nf, bands = 6) %>% raster::mean(na.rm = T)
jun.rsds.df <- as.data.frame(jun.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(jun.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.jun.rsds.txt")

jul.rsds.stack <- raster::stack(list.nf, bands = 7) %>% raster::mean(na.rm = T)
jul.rsds.df <- as.data.frame(jul.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(jul.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.jul.rsds.txt")

agu.rsds.stack <- raster::stack(list.nf, bands = 8) %>% raster::mean(na.rm = T)
agu.rsds.df <- as.data.frame(agu.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(agu.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.agu.rsds.txt")

sep.rsds.stack <- raster::stack(list.nf, bands = 9) %>% raster::mean(na.rm = T)
sep.rsds.df <- as.data.frame(sep.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(sep.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.sep.rsds.txt")

oct.rsds.stack <- raster::stack(list.nf, bands = 10) %>% raster::mean(na.rm = T)
oct.rsds.df <- as.data.frame(oct.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(oct.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.oct.rsds.txt")

nov.rsds.stack <- raster::stack(list.nf, bands = 11) %>% raster::mean(na.rm = T)
nov.rsds.df <- as.data.frame(nov.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(nov.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1850-1880.nov.rsds.txt")

dec.rsds.stack <- raster::stack(list.nf, bands = 12) %>% raster::mean(na.rm = T)
dec.rsds.df <- as.data.frame(dec.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.hist.1985-2015.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.ssp245.2030-2060.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.ssp245.2070-2100.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.ssp370.2030-2060.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.ssp370.2070-2100.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/awi.ssp585.2030-2060.fev.rsds.txt")
...
sfcWind.df <- as.data.frame(sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.hist.1850-1880.sfcWind.txt")

ggplot(sfcWind.df)+geom_raster(aes(x=lon, y = lat, fill = temp_k))

### mensual mean
jan.sfcWind.stack <- raster::stack(list.nf, bands = 1) %>% raster::mean(na.rm = T)
jan.sfcWind.df <- as.data.frame(jan.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
fev.sfcWind.df <- as.data.frame(fev.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.hist.1850-1880.fev.sfcWind.txt")

avr.sfcWind.stack <- raster::stack(list.nf, bands = 4) %>% raster::mean(na.rm = T)
avr.sfcWind.df <- as.data.frame(avr.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
may.sfcWind.df <- as.data.frame(may.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
jun.sfcWind.df <- as.data.frame(jun.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
jul.sfcWind.df <- as.data.frame(jul.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
agu.sfcWind.df <- as.data.frame(agu.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
sep.sfcWind.df <- as.data.frame(sep.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
oct.sfcWind.df <- as.data.frame(oct.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
nov.sfcWind.df <- as.data.frame(nov.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
dec.sfcWind.df <- as.data.frame(dec.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.hist.1985-2015.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp245.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp245.2070-2100.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp370.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp370.2070-2100.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp585.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = 3) %>% raster::mean(na.rm = T)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","temp_k"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/awi.ssp585.2070-2100.fev.sfcWind.txt")
