...
ggarrange(g2c, g2f, common.legend = T, legend = "bottom")
```
...
ggplot(martonne.w)+geom_raster(aes(x = lon, y = lat, fill = cat.AI))+
  ...
  scale_fill_manual(values = cat.colorvec)+theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
