...
```{r plot-regions}
ipcc_regions.sf <- readRDS("ipcc_regions.sf")
ggplot(filter(ipcc_regions.sf, Type %in% c("Land","Land-Ocean")))+geom_sf(aes(fill=Name))+geom_sf_label(aes(label = Name))+
...
compAI(AI1 = "unesco", AI2 = "martonne", df = all.ripcc.df[africa.lines,])
```
### S. america
...
compAI(AI1 = "unesco", AI2 = "martonne", df = all.ripcc.df[samerica.lines,])
```
### Australia
