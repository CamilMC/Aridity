...
write.table(awi_ipcc, "Aridity/CMIP6/awi.hhss_ipcc.txt")
...
write.table(awim_ipcc, "Aridity/CMIP6/awim.hhss_ipcc.txt")
...
write.table(bcc_ipcc, "Aridity/CMIP6/bcc.hhss_ipcc.txt")
...
write.table(bccm_ipcc, "Aridity/CMIP6/bccm.hhss_ipcc.txt")
# CAMS ----
## Annual ----
...
write.table(cams_ipcc, "Aridity/CMIP6/cams.hhss_ipcc.txt")
...
write.table(camsm_ipcc, "Aridity/CMIP6/camsm.hhss_ipcc.txt")
# CESM ----
...
write.table(cesm_ipcc, "Aridity/CMIP6/cesm.hhss_ipcc.txt")
...
write.table(cesmm_ipcc, "Aridity/CMIP6/cesmm.hhss_ipcc.txt")
...
write.table(cmcc_ipcc, "Aridity/CMIP6/cmcc.hhss_ipcc.txt")
...
write.table(cmccm_ipcc, "Aridity/CMIP6/cmccm.hhss_ipcc.txt")
...
write.table(cnrm_ipcc, "Aridity/CMIP6/cnrm.hhss_ipcc.txt")
...
write.table(cnrmm_ipcc, "Aridity/CMIP6/cnrmm.hhss_ipcc.txt")
...
write.table(fgoals_ipcc, "Aridity/CMIP6/fgoals.hhss_ipcc.txt")
## Monthly ---- 
...
write.table(fgoalsm_ipcc, "Aridity/CMIP6/fgoalsm.hhss_ipcc.txt")
...
write.table(inm_ipcc, "Aridity/CMIP6/inm.hhss_ipcc.txt")
...
write.table(inmm_ipcc, "Aridity/CMIP6/inmm.hhss_ipcc.txt")
# MPI ---- 
## Annual ----
...
write.table(mpi_ipcc, "Aridity/CMIP6/mpi.hhss_ipcc.txt")
...
write.table(mpim_ipcc, "Aridity/CMIP6/mpim.hhss_ipcc.txt")
...
write.table(mri_ipcc, "Aridity/CMIP6/mri.hhss_ipcc.txt")
...
write.table(mrim_ipcc, "Aridity/CMIP6/mrim.hhss_ipcc.txt")

# ALL hhss ANNUAL ----- 

all_annual <- mutate(read.table("Aridity/CMIP6/awi.hhss_ipcc.txt"), source = "AWI") %>% 
  rbind(mutate(read.table("Aridity/CMIP6/bcc.hhss_ipcc.txt"), source = "BCC")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/cams.hhss_ipcc.txt"), source = "CAMS")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/cesm.hhss_ipcc.txt"), source = "CESM")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/cmcc.hhss_ipcc.txt"), source = "CMCC")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/cnrm.hhss_ipcc.txt"), source = "CNRM")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/fgoals.hhss_ipcc.txt"), source = "FGOALS")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/inm.hhss_ipcc.txt"), source = "INM")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/mpi.hhss_ipcc.txt"), source = "MPI")) %>%
  rbind(mutate(read.table("Aridity/CMIP6/mri.hhss_ipcc.txt"), source = "MRI"))

write.table(filter(all_annual, lm == 1), "Aridity/hhss.all_annual.txt")

# ALL hhss MONTHLY ----

all_january <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 1), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 1), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 1), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 1), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 1), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 1), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 1), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 1), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 1), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 1), source = "MRI")) 

write.table(all_january, "Aridity/hhss.all_january.txt")

all_february <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 2), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 2), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 2), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 2), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 2), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 2), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 2), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 2), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 2), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 2), source = "MRI")) 

write.table(all_february, "Aridity/hhss.all_february.txt")

all_march <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 3), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 3), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 3), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 3), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 3), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 3), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 3), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 3), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 3), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 3), source = "MRI")) 

write.table(all_march, "Aridity/hhss.all_march.txt")

all_april <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 4), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 4), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 4), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 4), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 4), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 4), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 4), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 4), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 4), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 4), source = "MRI")) 

write.table(all_april, "Aridity/hhss.all_ahhssil.txt")

all_may <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 5), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 5), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 5), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 5), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 5), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 5), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 5), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 5), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 5), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 5), source = "MRI")) 

write.table(all_may, "Aridity/hhss.all_may.txt")

all_june <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 6), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 6), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 6), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 6), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 6), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 6), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 6), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 6), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 6), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 6), source = "MRI")) 

write.table(all_june, "Aridity/hhss.all_june.txt")

all_july <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 7), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 7), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 7), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 7), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 7), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 7), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 7), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 7), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 7), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 7), source = "MRI")) 

write.table(all_july, "Aridity/hhss.all_july.txt")

all_august <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 8), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 8), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 8), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 8), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 8), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 8), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 8), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 8), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 8), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 8), source = "MRI")) 

write.table(all_august, "Aridity/hhss.all_august.txt")

all_september <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 9), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 9), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 9), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 9), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 9), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 9), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 9), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 9), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 9), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 9), source = "MRI")) 

write.table(all_september, "Aridity/hhss.all_september.txt")

all_october <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 10), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 10), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 10), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 10), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 10), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 10), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 10), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 10), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 10), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 10), source = "MRI")) 

write.table(all_october, "Aridity/hhss.all_october.txt")

all_november <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 11), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 11), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 11), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 11), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 11), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 11), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 11), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 11), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 11), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 11), source = "MRI")) 

write.table(all_november, "Aridity/hhss.all_november.txt")

all_december <- mutate(filter(read.table("Aridity/CMIP6/awim.hhss_ipcc.txt"), lm == 1, month == 12), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.hhss_ipcc.txt"),lm == 1, month == 12), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.hhss_ipcc.txt"), lm == 1, month == 12), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.hhss_ipcc.txt"), lm == 1, month == 12), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.hhss_ipcc.txt"), lm == 1, month == 12), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.hhss_ipcc.txt"), lm == 1, month == 12), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.hhss_ipcc.txt"), lm == 1, month == 12), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.hhss_ipcc.txt"), lm == 1, month == 12), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.hhss_ipcc.txt"), lm == 1, month == 12), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.hhss_ipcc.txt"), lm == 1, month == 12), source = "MRI")) 

write.table(all_december, "Aridity/hhss.all_december.txt")