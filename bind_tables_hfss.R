...
cas_annual <- mutate(read.table("/bettik/crapartc/Averages/hfss/cas.esm2.hist.1850-1880.hfss.txt"), model = "historical", period = "1850_1880") %>% 
...
all_january <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 1), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 1), source = "EC-Earth3")) %>%
...
all_february <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 2), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 2), source = "EC-Earth3")) %>%
...
all_march <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 3), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 3), source = "EC-Earth3")) %>%
...
all_april <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 4), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 4), source = "EC-Earth3")) %>%
...
all_may <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 5), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 5), source = "EC-Earth3")) %>%
...
all_june <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 6), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 6), source = "EC-Earth3")) %>%
...
all_july <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 7), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 7), source = "EC-Earth3")) %>%
...
all_august <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 8), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 8), source = "EC-Earth3")) %>%
...
all_september <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 9), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 9), source = "EC-Earth3")) %>%
...
all_october <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 10), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 10), source = "EC-Earth3")) %>%
...
all_november <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 11), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 11), source = "EC-Earth3")) %>%
...
all_december <- mutate(filter(read.table("/bettik/crapartc/IPCC/cas.esm2m.hfss_ipcc.txt"), lm == 1, month == 12), source = "CAS-ESM2") %>%
  ...
  rbind(mutate(filter(read.table("/bettik/crapartc/IPCC/ec-earth3.hfss_ipcc.txt"), lm == 1, month == 12), source = "EC-Earth3")) %>%
