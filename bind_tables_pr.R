...
awi_monthly <- mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.jan.pr.txt"), model = "historical", period = "1850_1880", month = 1) %>%
  ...
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.avr.pr.txt"), model = "historical", period = "1850_1880", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.avr.pr.txt"), model = "historical", period = "1970_2000", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.avr.pr.txt"), model = "historical", period = "1985_2015", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.avr.pr.txt"), model = "SSP245", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.avr.pr.txt"), model = "SSP245", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.avr.pr.txt"), model = "SSP370", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.avr.pr.txt"), model = "SSP370", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.avr.pr.txt"), model = "SSP585", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.avr.pr.txt"), model = "SSP585", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.may.pr.txt"), model = "historical", period = "1850_1880", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.may.pr.txt"), model = "historical", period = "1970_2000", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.may.pr.txt"), model = "historical", period = "1985_2015", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.may.pr.txt"), model = "SSP245", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.may.pr.txt"), model = "SSP245", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.may.pr.txt"), model = "SSP370", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.may.pr.txt"), model = "SSP370", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.may.pr.txt"), model = "SSP585", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.may.pr.txt"), model = "SSP585", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.jun.pr.txt"), model = "historical", period = "1850_1880", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.jun.pr.txt"), model = "historical", period = "1970_2000", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.jun.pr.txt"), model = "historical", period = "1985_2015", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.jun.pr.txt"), model = "SSP245", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.jun.pr.txt"), model = "SSP245", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.jun.pr.txt"), model = "SSP370", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.jun.pr.txt"), model = "SSP370", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.jun.pr.txt"), model = "SSP585", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.jun.pr.txt"), model = "SSP585", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.jul.pr.txt"), model = "historical", period = "1850_1880", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.jul.pr.txt"), model = "historical", period = "1970_2000", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.jul.pr.txt"), model = "historical", period = "1985_2015", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.jul.pr.txt"), model = "SSP245", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.jul.pr.txt"), model = "SSP245", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.jul.pr.txt"), model = "SSP370", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.jul.pr.txt"), model = "SSP370", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.jul.pr.txt"), model = "SSP585", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.jul.pr.txt"), model = "SSP585", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.agu.pr.txt"), model = "historical", period = "1850_1880", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.agu.pr.txt"), model = "historical", period = "1970_2000", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.agu.pr.txt"), model = "historical", period = "1985_2015", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.agu.pr.txt"), model = "SSP245", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.agu.pr.txt"), model = "SSP245", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.agu.pr.txt"), model = "SSP370", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.agu.pr.txt"), model = "SSP370", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.agu.pr.txt"), model = "SSP585", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.agu.pr.txt"), model = "SSP585", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.sep.pr.txt"), model = "historical", period = "1850_1880", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.sep.pr.txt"), model = "historical", period = "1970_2000", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.sep.pr.txt"), model = "historical", period = "1985_2015", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.sep.pr.txt"), model = "SSP245", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.sep.pr.txt"), model = "SSP245", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.sep.pr.txt"), model = "SSP370", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.sep.pr.txt"), model = "SSP370", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.sep.pr.txt"), model = "SSP585", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.sep.pr.txt"), model = "SSP585", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.oct.pr.txt"), model = "historical", period = "1850_1880", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.oct.pr.txt"), model = "historical", period = "1970_2000", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.oct.pr.txt"), model = "historical", period = "1985_2015", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.oct.pr.txt"), model = "SSP245", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.oct.pr.txt"), model = "SSP245", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.oct.pr.txt"), model = "SSP370", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.oct.pr.txt"), model = "SSP370", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.oct.pr.txt"), model = "SSP585", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.oct.pr.txt"), model = "SSP585", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.nov.pr.txt"), model = "historical", period = "1850_1880", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.nov.pr.txt"), model = "historical", period = "1970_2000", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.nov.pr.txt"), model = "historical", period = "1985_2015", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.nov.pr.txt"), model = "SSP245", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.nov.pr.txt"), model = "SSP245", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.nov.pr.txt"), model = "SSP370", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.nov.pr.txt"), model = "SSP370", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.nov.pr.txt"), model = "SSP585", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.nov.pr.txt"), model = "SSP585", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1850-1880.dec.pr.txt"), model = "historical", period = "1850_1880", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1970-2000.dec.pr.txt"), model = "historical", period = "1970_2000", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.hist.1985-2015.dec.pr.txt"), model = "historical", period = "1985_2015", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2030-2060.dec.pr.txt"), model = "SSP245", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp245.2070-2100.dec.pr.txt"), model = "SSP245", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2030-2060.dec.pr.txt"), model = "SSP370", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp370.2070-2100.dec.pr.txt"), model = "SSP370", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2030-2060.dec.pr.txt"), model = "SSP585", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/awi.ssp585.2070-2100.dec.pr.txt"), model = "SSP585", period = "2070_2100", month = 12)) 
...
bcc_annual <- mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.pr.txt"), model = "historical", period = "1850_1880") %>% 
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.pr.txt"), model = "historical", period = "1970_2000")) %>%
...
bcc_monthly <- mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.jan.pr.txt"), model = "historical", period = "1850_1880", month = 1) %>%
  ...
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.avr.pr.txt"), model = "historical", period = "1850_1880", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.avr.pr.txt"), model = "historical", period = "1970_2000", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.avr.pr.txt"), model = "historical", period = "1985_2015", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.avr.pr.txt"), model = "SSP245", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.avr.pr.txt"), model = "SSP245", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.avr.pr.txt"), model = "SSP370", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.avr.pr.txt"), model = "SSP370", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.avr.pr.txt"), model = "SSP585", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.avr.pr.txt"), model = "SSP585", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.may.pr.txt"), model = "historical", period = "1850_1880", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.may.pr.txt"), model = "historical", period = "1970_2000", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.may.pr.txt"), model = "historical", period = "1985_2015", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.may.pr.txt"), model = "SSP245", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.may.pr.txt"), model = "SSP245", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.may.pr.txt"), model = "SSP370", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.may.pr.txt"), model = "SSP370", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.may.pr.txt"), model = "SSP585", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.may.pr.txt"), model = "SSP585", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.jun.pr.txt"), model = "historical", period = "1850_1880", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.jun.pr.txt"), model = "historical", period = "1970_2000", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.jun.pr.txt"), model = "historical", period = "1985_2015", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.jun.pr.txt"), model = "SSP245", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.jun.pr.txt"), model = "SSP245", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.jun.pr.txt"), model = "SSP370", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.jun.pr.txt"), model = "SSP370", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.jun.pr.txt"), model = "SSP585", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.jun.pr.txt"), model = "SSP585", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.jul.pr.txt"), model = "historical", period = "1850_1880", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.jul.pr.txt"), model = "historical", period = "1970_2000", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.jul.pr.txt"), model = "historical", period = "1985_2015", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.jul.pr.txt"), model = "SSP245", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.jul.pr.txt"), model = "SSP245", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.jul.pr.txt"), model = "SSP370", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.jul.pr.txt"), model = "SSP370", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.jul.pr.txt"), model = "SSP585", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.jul.pr.txt"), model = "SSP585", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.agu.pr.txt"), model = "historical", period = "1850_1880", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.agu.pr.txt"), model = "historical", period = "1970_2000", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.agu.pr.txt"), model = "historical", period = "1985_2015", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.agu.pr.txt"), model = "SSP245", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.agu.pr.txt"), model = "SSP245", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.agu.pr.txt"), model = "SSP370", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.agu.pr.txt"), model = "SSP370", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.agu.pr.txt"), model = "SSP585", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.agu.pr.txt"), model = "SSP585", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.sep.pr.txt"), model = "historical", period = "1850_1880", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.sep.pr.txt"), model = "historical", period = "1970_2000", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.sep.pr.txt"), model = "historical", period = "1985_2015", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.sep.pr.txt"), model = "SSP245", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.sep.pr.txt"), model = "SSP245", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.sep.pr.txt"), model = "SSP370", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.sep.pr.txt"), model = "SSP370", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.sep.pr.txt"), model = "SSP585", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.sep.pr.txt"), model = "SSP585", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.oct.pr.txt"), model = "historical", period = "1850_1880", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.oct.pr.txt"), model = "historical", period = "1970_2000", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.oct.pr.txt"), model = "historical", period = "1985_2015", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.oct.pr.txt"), model = "SSP245", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.oct.pr.txt"), model = "SSP245", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.oct.pr.txt"), model = "SSP370", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.oct.pr.txt"), model = "SSP370", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.oct.pr.txt"), model = "SSP585", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.oct.pr.txt"), model = "SSP585", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.nov.pr.txt"), model = "historical", period = "1850_1880", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.nov.pr.txt"), model = "historical", period = "1970_2000", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.nov.pr.txt"), model = "historical", period = "1985_2015", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.nov.pr.txt"), model = "SSP245", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.nov.pr.txt"), model = "SSP245", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.nov.pr.txt"), model = "SSP370", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.nov.pr.txt"), model = "SSP370", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.nov.pr.txt"), model = "SSP585", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.nov.pr.txt"), model = "SSP585", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1850-1880.dec.pr.txt"), model = "historical", period = "1850_1880", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1970-2000.dec.pr.txt"), model = "historical", period = "1970_2000", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.hist.1985-2015.dec.pr.txt"), model = "historical", period = "1985_2015", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2030-2060.dec.pr.txt"), model = "SSP245", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp245.2070-2100.dec.pr.txt"), model = "SSP245", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2030-2060.dec.pr.txt"), model = "SSP370", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp370.2070-2100.dec.pr.txt"), model = "SSP370", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2030-2060.dec.pr.txt"), model = "SSP585", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/bcc.ssp585.2070-2100.dec.pr.txt"), model = "SSP585", period = "2070_2100", month = 12)) 
...
cams_monthly <- mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.jan.pr.txt"), model = "historical", period = "1850_1880", month = 1) %>%
  ...
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.avr.pr.txt"), model = "SSP245", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.avr.pr.txt"), model = "SSP245", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.avr.pr.txt"), model = "SSP370", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.avr.pr.txt"), model = "SSP370", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.avr.pr.txt"), model = "SSP585", period = "2030_2060", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.avr.pr.txt"), model = "SSP585", period = "2070_2100", month = 4)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.may.pr.txt"), model = "historical", period = "1850_1880", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.may.pr.txt"), model = "historical", period = "1970_2000", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.may.pr.txt"), model = "historical", period = "1985_2015", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.may.pr.txt"), model = "SSP245", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.may.pr.txt"), model = "SSP245", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.may.pr.txt"), model = "SSP370", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.may.pr.txt"), model = "SSP370", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.may.pr.txt"), model = "SSP585", period = "2030_2060", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.may.pr.txt"), model = "SSP585", period = "2070_2100", month = 5)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.jun.pr.txt"), model = "historical", period = "1850_1880", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.jun.pr.txt"), model = "historical", period = "1970_2000", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.jun.pr.txt"), model = "historical", period = "1985_2015", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.jun.pr.txt"), model = "SSP245", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.jun.pr.txt"), model = "SSP245", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.jun.pr.txt"), model = "SSP370", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.jun.pr.txt"), model = "SSP370", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.jun.pr.txt"), model = "SSP585", period = "2030_2060", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.jun.pr.txt"), model = "SSP585", period = "2070_2100", month = 6)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.jul.pr.txt"), model = "historical", period = "1850_1880", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.jul.pr.txt"), model = "historical", period = "1970_2000", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.jul.pr.txt"), model = "historical", period = "1985_2015", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.jul.pr.txt"), model = "SSP245", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.jul.pr.txt"), model = "SSP245", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.jul.pr.txt"), model = "SSP370", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.jul.pr.txt"), model = "SSP370", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.jul.pr.txt"), model = "SSP585", period = "2030_2060", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.jul.pr.txt"), model = "SSP585", period = "2070_2100", month = 7)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.agu.pr.txt"), model = "historical", period = "1850_1880", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.agu.pr.txt"), model = "historical", period = "1970_2000", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.agu.pr.txt"), model = "historical", period = "1985_2015", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.agu.pr.txt"), model = "SSP245", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.agu.pr.txt"), model = "SSP245", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.agu.pr.txt"), model = "SSP370", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.agu.pr.txt"), model = "SSP370", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.agu.pr.txt"), model = "SSP585", period = "2030_2060", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.agu.pr.txt"), model = "SSP585", period = "2070_2100", month = 8)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.sep.pr.txt"), model = "historical", period = "1850_1880", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.sep.pr.txt"), model = "historical", period = "1970_2000", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.sep.pr.txt"), model = "historical", period = "1985_2015", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.sep.pr.txt"), model = "SSP245", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.sep.pr.txt"), model = "SSP245", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.sep.pr.txt"), model = "SSP370", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.sep.pr.txt"), model = "SSP370", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.sep.pr.txt"), model = "SSP585", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.sep.pr.txt"), model = "SSP585", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.oct.pr.txt"), model = "historical", period = "1850_1880", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.oct.pr.txt"), model = "historical", period = "1970_2000", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.oct.pr.txt"), model = "historical", period = "1985_2015", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.oct.pr.txt"), model = "SSP245", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.oct.pr.txt"), model = "SSP245", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.oct.pr.txt"), model = "SSP370", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.oct.pr.txt"), model = "SSP370", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.oct.pr.txt"), model = "SSP585", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.oct.pr.txt"), model = "SSP585", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.nov.pr.txt"), model = "historical", period = "1850_1880", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.nov.pr.txt"), model = "historical", period = "1970_2000", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.nov.pr.txt"), model = "historical", period = "1985_2015", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.nov.pr.txt"), model = "SSP245", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.nov.pr.txt"), model = "SSP245", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.nov.pr.txt"), model = "SSP370", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.nov.pr.txt"), model = "SSP370", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.nov.pr.txt"), model = "SSP585", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.nov.pr.txt"), model = "SSP585", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1850-1880.dec.pr.txt"), model = "historical", period = "1850_1880", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1970-2000.dec.pr.txt"), model = "historical", period = "1970_2000", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.hist.1985-2015.dec.pr.txt"), model = "historical", period = "1985_2015", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2030-2060.dec.pr.txt"), model = "SSP245", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp245.2070-2100.dec.pr.txt"), model = "SSP245", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2030-2060.dec.pr.txt"), model = "SSP370", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp370.2070-2100.dec.pr.txt"), model = "SSP370", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2030-2060.dec.pr.txt"), model = "SSP585", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/cams.ssp585.2070-2100.dec.pr.txt"), model = "SSP585", period = "2070_2100", month = 12)) 
...
inm_monthly <- mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1850-1880.jan.pr.txt"), model = "historical", period = "1850_1880", month = 1) %>%
  ...
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2030-2060.agu.pr.txt"), model = "SSP245", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2070-2100.agu.pr.txt"), model = "SSP245", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2030-2060.agu.pr.txt"), model = "SSP370", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2070-2100.agu.pr.txt"), model = "SSP370", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2030-2060.agu.pr.txt"), model = "SSP585", period = "2030_2060", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2070-2100.agu.pr.txt"), model = "SSP585", period = "2070_2100", month = 9)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1850-1880.sep.pr.txt"), model = "historical", period = "1850_1880", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1970-2000.sep.pr.txt"), model = "historical", period = "1970_2000", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1985-2015.sep.pr.txt"), model = "historical", period = "1985_2015", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2030-2060.sep.pr.txt"), model = "SSP245", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2070-2100.sep.pr.txt"), model = "SSP245", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2030-2060.sep.pr.txt"), model = "SSP370", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2070-2100.sep.pr.txt"), model = "SSP370", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2030-2060.sep.pr.txt"), model = "SSP585", period = "2030_2060", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2070-2100.sep.pr.txt"), model = "SSP585", period = "2070_2100", month = 10)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1850-1880.oct.pr.txt"), model = "historical", period = "1850_1880", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1985-2015.oct.pr.txt"), model = "historical", period = "1985_2015", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2030-2060.oct.pr.txt"), model = "SSP245", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2070-2100.oct.pr.txt"), model = "SSP245", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2030-2060.oct.pr.txt"), model = "SSP370", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2070-2100.oct.pr.txt"), model = "SSP370", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2030-2060.oct.pr.txt"), model = "SSP585", period = "2030_2060", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2070-2100.oct.pr.txt"), model = "SSP585", period = "2070_2100", month = 11)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1850-1880.nov.pr.txt"), model = "historical", period = "1850_1880", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1970-2000.nov.pr.txt"), model = "historical", period = "1970_2000", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.hist.1985-2015.nov.pr.txt"), model = "historical", period = "1985_2015", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2030-2060.nov.pr.txt"), model = "SSP245", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp245.2070-2100.nov.pr.txt"), model = "SSP245", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2030-2060.nov.pr.txt"), model = "SSP370", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp370.2070-2100.nov.pr.txt"), model = "SSP370", period = "2070_2100", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2030-2060.nov.pr.txt"), model = "SSP585", period = "2030_2060", month = 12)) %>%
  rbind(mutate(read.table("/bettik/crapartc/Averages/pr/inm.ssp585.2070-2100.nov.pr.txt"), model = "SSP585", period = "2070_2100", month = 12)) 
...
all_january <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 1), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 1), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 1), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 1), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 1), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 1), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 1), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 1), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 1), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 1), source = "MRI")) 

write.table(all_january, "Aridity/pr.all_january.txt")

all_february <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 2), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 2), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 2), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 2), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 2), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 2), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 2), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 2), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 2), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 2), source = "MRI")) 

write.table(all_february, "Aridity/pr.all_february.txt")

all_march <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 3), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 3), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 3), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 3), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 3), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 3), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 3), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 3), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 3), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 3), source = "MRI")) 

write.table(all_march, "Aridity/pr.all_march.txt")

all_april <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 4), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 4), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 4), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 4), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 4), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 4), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 4), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 4), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 4), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 4), source = "MRI")) 

write.table(all_april, "Aridity/pr.all_april.txt")

all_may <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 5), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 5), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 5), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 5), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 5), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 5), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 5), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 5), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 5), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 5), source = "MRI")) 

write.table(all_may, "Aridity/pr.all_may.txt")

all_june <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 6), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 6), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 6), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 6), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 6), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 6), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 6), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 6), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 6), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 6), source = "MRI")) 

write.table(all_june, "Aridity/pr.all_june.txt")

all_july <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 7), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 7), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 7), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 7), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 7), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 7), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 7), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 7), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 7), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 7), source = "MRI")) 

write.table(all_july, "Aridity/pr.all_july.txt")

all_august <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 8), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 8), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 8), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 8), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 8), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 8), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 8), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 8), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 8), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 8), source = "MRI")) 

write.table(all_august, "Aridity/pr.all_august.txt")

all_september <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 9), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 9), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 9), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 9), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 9), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 9), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 9), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 9), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 9), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 9), source = "MRI")) 

write.table(all_september, "Aridity/pr.all_september.txt")

all_october <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 10), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 10), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 10), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 10), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 10), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 10), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 10), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 10), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 10), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 10), source = "MRI")) 

write.table(all_october, "Aridity/pr.all_october.txt")

all_november <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 11), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 11), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 11), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 11), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 11), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 11), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 11), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 11), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 11), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 11), source = "MRI")) 

write.table(all_november, "Aridity/pr.all_november.txt")

all_december <- mutate(filter(read.table("Aridity/CMIP6/awim.pr_ipcc.txt"), lm == 1, month == 12), source = "AWI") %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/bccm.pr_ipcc.txt"),lm == 1, month == 12), source = "BCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/camsm.pr_ipcc.txt"), lm == 1, month == 12), source = "CAMS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cesmm.pr_ipcc.txt"), lm == 1, month == 12), source = "CESM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cmccm.pr_ipcc.txt"), lm == 1, month == 12), source = "CMCC")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/cnrmm.pr_ipcc.txt"), lm == 1, month == 12), source = "CNRM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/fgoalsm.pr_ipcc.txt"), lm == 1, month == 12), source = "FGOALS")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/inmm.pr_ipcc.txt"), lm == 1, month == 12), source = "INM")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mpim.pr_ipcc.txt"), lm == 1, month == 12), source = "MPI")) %>%
  rbind(mutate(filter(read.table("Aridity/CMIP6/mrim.pr_ipcc.txt"), lm == 1, month == 12), source = "MRI")) 

write.table(all_december, "Aridity/pr.all_december.txt")