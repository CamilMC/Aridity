...
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.hist.1850-1880.fev.ts.txt")
...
jan.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jan.ts.df <- as.data.frame(jan.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
fev.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
fev.ts.df <- as.data.frame(fev.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
mar.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.hist.1985-2015.fev.ts.txt")
...
avr.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
avr.ts.df <- as.data.frame(avr.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
may.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
may.ts.df <- as.data.frame(may.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
jun.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jun.ts.df <- as.data.frame(jun.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
jul.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jul.ts.df <- as.data.frame(jul.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
agu.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
agu.ts.df <- as.data.frame(agu.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
sep.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
sep.ts.df <- as.data.frame(sep.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
oct.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
oct.ts.df <- as.data.frame(oct.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
nov.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
nov.ts.df <- as.data.frame(nov.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
dec.ts.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
dec.ts.df <- as.data.frame(dec.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
...
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp245.2030-2060.fev.ts.txt")
...
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp245.2070-2100.fev.ts.txt")
...
mar.ts.stack <- raster::stack(list.nf, bands =  seq(from = 183, to = 531, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp370.2030-2060.fev.ts.txt")
...
mar.ts.stack <- raster::stack(list.nf, bands =  seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp370.2070-2100.fev.ts.txt")
...
mar.ts.stack <- raster::stack(list.nf, bands = seq(from = 183, to = 531, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp585.2030-2060.fev.ts.txt")
...
mar.ts.stack <- raster::stack(list.nf, bands =  seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.ts.df <- as.data.frame(mar.ts.stack, xy = T) %>% setNames(c("lon","lat","ts"))
write.table(mar.ts.df, file = "/bettik/crapartc/Averages/ts/inm.ssp585.2070-2100.fev.ts.txt")
...
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.hist.1850-1880.fev.pr.txt")
...
jan.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jan.pr.df <- as.data.frame(jan.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
fev.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
fev.pr.df <- as.data.frame(fev.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
mar.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.hist.1985-2015.fev.pr.txt")
...
avr.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
avr.pr.df <- as.data.frame(avr.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
may.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
may.pr.df <- as.data.frame(may.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
jun.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jun.pr.df <- as.data.frame(jun.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
jul.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jul.pr.df <- as.data.frame(jul.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
agu.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
agu.pr.df <- as.data.frame(agu.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
sep.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
sep.pr.df <- as.data.frame(sep.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
oct.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
oct.pr.df <- as.data.frame(oct.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
nov.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
nov.pr.df <- as.data.frame(nov.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
dec.pr.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
dec.pr.df <- as.data.frame(dec.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
...
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp245.2030-2060.fev.pr.txt")
...
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp245.2070-2100.fev.pr.txt")
...
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp370.2030-2060.fev.pr.txt")
...
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp370.2070-2100.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = seq(from = 183, to = 531, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp585.2030-2060.fev.pr.txt")
...
mar.pr.stack <- raster::stack(list.nf, bands = seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.pr.df <- as.data.frame(mar.pr.stack, xy = T) %>% setNames(c("lon","lat","pr"))
write.table(mar.pr.df, file = "/bettik/crapartc/Averages/pr/inm.ssp585.2070-2100.fev.pr.txt")
...
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.hist.1850-1880.fev.rsds.txt")
...
jan.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jan.rsds.df <- as.data.frame(jan.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
fev.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
fev.rsds.df <- as.data.frame(fev.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
mar.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.hist.1985-2015.fev.rsds.txt")
...
avr.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
avr.rsds.df <- as.data.frame(avr.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
may.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
may.rsds.df <- as.data.frame(may.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
jun.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jun.rsds.df <- as.data.frame(jun.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
jul.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jul.rsds.df <- as.data.frame(jul.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
agu.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
agu.rsds.df <- as.data.frame(agu.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
sep.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
sep.rsds.df <- as.data.frame(sep.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
oct.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
oct.rsds.df <- as.data.frame(oct.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
nov.rsds.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
nov.rsds.df <- as.data.frame(nov.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
...
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp245.2030-2060.fev.rsds.txt")
...
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp245.2070-2100.fev.rsds.txt")
...
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp370.2030-2060.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds*"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp370.2070-2100.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = seq(from = 183, to = 531)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds*"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp585.2030-2060.fev.rsds.txt")
...
mar.rsds.stack <- raster::stack(list.nf, bands = seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.rsds.df <- as.data.frame(mar.rsds.stack, xy = T) %>% setNames(c("lon","lat","rsds*"))
write.table(mar.rsds.df, file = "/bettik/crapartc/Averages/rsds/inm.ssp585.2070-2100.fev.rsds.txt")
...
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.hist.1850-1880.fev.sfcWind.txt")
...
jan.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jan.sfcWind.df <- as.data.frame(jan.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
fev.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
fev.sfcWind.df <- as.data.frame(fev.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
mar.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.hist.1985-2015.fev.sfcWind.txt")
...
avr.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
avr.sfcWind.df <- as.data.frame(avr.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
may.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
may.sfcWind.df <- as.data.frame(may.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
jun.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jun.sfcWind.df <- as.data.frame(jun.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
jul.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
jul.sfcWind.df <- as.data.frame(jul.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
agu.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
agu.sfcWind.df <- as.data.frame(agu.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
sep.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
sep.sfcWind.df <- as.data.frame(sep.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
oct.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
oct.sfcWind.df <- as.data.frame(oct.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
nov.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
nov.sfcWind.df <- as.data.frame(nov.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
dec.sfcWind.stack <- raster::stack(list.nf) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
dec.sfcWind.df <- as.data.frame(dec.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
...
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp245.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp245.2070-2100.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = seq(from = 183, to = 531, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp370.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp370.2070-2100.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = seq(from = 183, to = 531, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp585.2030-2060.fev.sfcWind.txt")
...
mar.sfcWind.stack <- raster::stack(list.nf, bands = seq(from = 663, to = 1011, by = 12)) %>% raster::mean(na.rm = T) %>% projectRaster(ex_raster)
mar.sfcWind.df <- as.data.frame(mar.sfcWind.stack, xy = T) %>% setNames(c("lon","lat","sfcWind"))
write.table(mar.sfcWind.df, file = "/bettik/crapartc/Averages/sfcWind/inm.ssp585.2070-2100.fev.sfcWind.txt")
