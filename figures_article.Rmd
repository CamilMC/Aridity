...
cmip6.ref$cat.AI[which(cmip6s$ET0.ref < 400)] <- "Cold"
...
cmip6 <- filter(calib, source == "CMIP6") %>% select(c("lon","lat","cat.AI")) %>% setNames(c("lon","lat","cat.AI.cmip6"))
...
all <- merge(wdc, era5, by = c("lon","lat")) %>% merge(cmip6, by = c("lon","lat")) %>% 
...
all$cmip6vswdc <- with(all, ifelse(cat.AI.cmip6 == cat.AI.wdc, "same","diff"))
all$cmip6vsera5 <- with(all, ifelse(cat.AI.cmip6 == cat.AI.era5, "same","diff"))

all$casesm2.vswdc <- with(all, ifelse(cat.AI.casesm2 == cat.AI.wdc, "same","diff"))
all$cesm.vswdc <- with(all, ifelse(cat.AI.cesm == cat.AI.wdc, "same","diff"))
all$cmcc.vswdc <- with(all, ifelse(cat.AI.cmcc == cat.AI.wdc, "same","diff"))
all$cmccesm2.vswdc <- with(all, ifelse(cat.AI.cmccesm2 == cat.AI.wdc, "same","diff"))
all$cnrm.vswdc <- with(all, ifelse(cat.AI.cnrm == cat.AI.wdc, "same","diff"))
all$ecearth3.vswdc <- with(all, ifelse(cat.AI.ecearth3 == cat.AI.wdc, "same","diff"))
all$fgoals.vswdc <- with(all, ifelse(cat.AI.fgoals == cat.AI.wdc, "same","diff"))
all$gfdlesm4.vswdc <- with(all, ifelse(cat.AI.gfdlesm4 == cat.AI.wdc, "same","diff"))
all$inm.vswdc <- with(all, ifelse(cat.AI.inm == cat.AI.wdc, "same","diff"))
all$inmcm5.vswdc <- with(all, ifelse(cat.AI.inmcm5 == cat.AI.wdc, "same","diff"))
all$mpi.vswdc <- with(all, ifelse(cat.AI.mpi == cat.AI.wdc, "same","diff"))
all$mri.vswdc <- with(all, ifelse(cat.AI.mri == cat.AI.wdc, "same","diff"))
all$noresm.vswdc <- with(all, ifelse(cat.AI.noresm == cat.AI.wdc, "same","diff"))

table(all$cmip6vswdc) %>% as.data.frame() %>% setNames(c("diffornot", "CMIP6-WDC")
table(all$casesm2vswdc) %>% as.data.frame() %>% setNames(c("diffornot", "CASESM2-WDC")
table(all$cmccvswdc) %>% as.data.frame() %>% setNames(c("diffornot", "CASESM2-WDC")



table(all$cmip6vsera5)
```
