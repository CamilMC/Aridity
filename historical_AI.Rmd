...
write.table(land_mask.df, "CMIP6_data/archives/land_mask.txt")
...
write.table(ipcc_regions.df, "CMIP6_data/archives/ipcc_regions.txt")

elev <- raster("CMIP6_data/archives/elevation_100KMmn_GMTEDmn.tif") %>% projectRaster(to = ripcc_regions)
...
```{r AI-De-Martonne}
list.temp <- list.files(path = "CMIP6_data/archives/historical/ts", pattern = ".nc", full.names = T)
list.pre <- list.files(path = "CMIP6_data/archives/historical/pr", pattern = ".nc", full.names = T)
...
for(i in 1:length(list.temp)){
  ...
  writeRaster(AI1, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1850-1880.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot1.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1850-1880.csv", sep = "_"))
  sorted.df1 <- table(tot1.land$cat.AI,tot1.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1850","_")))
  write.table(sorted.df1, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1850-1880.csv", sep = "_"))
  ...
  ggsave(filename = paste(mname,"AI_Martonne_1850-1880.png", sep = "_"),g1, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  writeRaster(AI2, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1984-2014.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot2.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1984-2014.csv", sep = "_"))
  sorted.df2 <- table(tot2.land$cat.AI,tot2.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1984", sep = "_")))
    write.table(sorted.df2, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1984-2014.csv", sep = "_"))
  ...
  g2 <- ggplot(tot2.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    ...
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1984-2014.png", sep = "_"),g2, path = "CMIP6_data/archives/historical/Martonne/")
...
for(i in 1:length(list.temp)){
  ...
  writeRaster(AI0, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1850-1880.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot0.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1850-1880.csv", sep = "_"))
  sorted.df0 <- table(tot0.land$cat.AI,tot1.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1850","_")))
  write.table(sorted.df0, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1850-1880.csv", sep = "_"))
  ...
  g0 <- ggplot(tot0.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    ...
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1850-1880.png", sep = "_"),g0, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  extent(AI1) <- c(-180,180,-90,90)
  AI1 <- projectRaster(from = AI1, to = ripcc_regions)
  writeRaster(AI1, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1880-1910.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  tot1.land <- subset(tot1,lm == 1)
  tot1.land$model <- mname
  write.table(tot1.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1880-1910.csv", sep = "_"))
  sorted.df1 <- table(tot1.land$cat.AI,tot1.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1880","_")))
  write.table(sorted.df1, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1880-1910.csv", sep = "_"))
  
  g1 <- ggplot(tot1.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "grey90")+  labs(title = paste(mname,"1880-1910", sep = "_"), fill = "")+
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1880-1910.png", sep = "_"),g1, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  extent(AI2) <- c(-180,180,-90,90)
  AI2 <- projectRaster(from = AI2, to = ripcc_regions)
  writeRaster(AI2, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1910-1940.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  tot2.land <- subset(tot2,lm == 1)
  tot2.land$model <- mname
  write.table(tot2.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1910-1940.csv", sep = "_"))
  sorted.df2 <- table(tot2.land$cat.AI,tot2.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1910", sep = "_")))
    write.table(sorted.df2, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1910-1940.csv", sep = "_"))
  
  g2 <- ggplot(tot2.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "grey90")+  labs(title = paste(mname,"1910-1940", sep = "_"), fill = "")+
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1910-1940.png", sep = "_"),g2, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  writeRaster(AI3, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1940-1970.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot3.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1940-1970.csv", sep = "_"))
  sorted.df3 <- table(tot3.land$cat.AI,tot3.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1940", sep = "_")))
    write.table(sorted.df3, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1940-1970.csv", sep = "_"))
  ...
  g3 <- ggplot(tot3.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    ...
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1940-1970.png", sep = "_"),g3, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  writeRaster(AI4, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1970-2000.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot4.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1970-2000.csv", sep = "_"))
  sorted.df4 <- table(tot4.land$cat.AI,tot4.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1970", sep = "_")))
    write.table(sorted.df4, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1970-2000.csv", sep = "_"))
  ...
  g4 <- ggplot(tot4.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    ...
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1970-2000.png", sep = "_"),g4, path = "CMIP6_data/archives/historical/Martonne/")
  ...
  writeRaster(AI5, filename = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1984-2014.nc", sep = "_"), format = "CDF", overwrite = T)
  ...
  write.table(tot5.land, file = paste("CMIP6_data/archives/historical/Martonne/AI",mname,"1984-2014.csv", sep = "_"))
  sorted.df5 <- table(tot5.land$cat.AI,tot2.land$Acronym) %>% as.data.frame() %>% setNames(c("cat.AI","Region",paste(mname,"1984", sep = "_")))
    write.table(sorted.df5, file = paste("CMIP6_data/archives/historical/Martonne/region_AI",mname,"1984-2014.csv", sep = "_"))
  ...
  g5 <- ggplot(tot5.land)+geom_raster(aes(x=lon, y = lat, fill = cat.AI))+
    ...
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))
  ggsave(filename = paste(mname,"AI_Martonne_1984-2014.png", sep = "_"),g5, path = "CMIP6_data/archives/historical/Martonne/")
}
...
#load files
list.region.1850 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1850-1880.csv", full.names = T)
list.region.1880 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1880-1910.csv", full.names = T)
list.region.1910 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1910-1940.csv", full.names = T)
list.region.1940 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1940-1970.csv", full.names = T)
list.region.1970 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1970-2000.csv", full.names = T)
list.region.1984 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "region_AI*.*1984-2014.csv", full.names = T)

list.tot.df.1850 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1850-1880.csv", full.names = T) %>% setdiff(list.region.1850)  %>% lapply(read.table, header = T)
list.tot.df.1880 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1880-1910.csv", full.names = T) %>% setdiff(list.region.1880)  %>% lapply(read.table, header = T)
list.tot.df.1910 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1910-1940.csv", full.names = T) %>% setdiff(list.region.1910)  %>% lapply(read.table, header = T)
list.tot.df.1940 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1940-1970.csv", full.names = T) %>% setdiff(list.region.1940)  %>% lapply(read.table, header = T)
list.tot.df.1970 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1970-2000.csv", full.names = T) %>% setdiff(list.region.1970)  %>% lapply(read.table, header = T)
list.tot.df.1984 <- list.files(path = "CMIP6_data/archives/historical/Martonne/", pattern = "1984-2014.csv", full.names = T) %>% setdiff(list.region.1984)  %>% lapply(read.table, header = T)
...
diff.df <- merge(df_1850, df_1940, by = c("lon","lat","Continent","Type","Name","Acronym","model","lm")) %>% mutate(diff.AI = AI.y - AI.x, sign.diff = ifelse(diff.AI > 0,"+","-"))
...
ggplot()+geom_raster(data = sum_diff, aes(x=lon, y = lat, fill = cat.diff))+
    ...
    scale_fill_viridis_d(direction = -1, na.value = "grey90")+labs(title = "Change in AI 1940-1970 compared to 1850-1880", fill = "")+
    theme_void(base_size = 10)+theme(legend.position = "bottom")+guides(fill = guide_legend(nrow = 2))

# 1984-2014
df_1984 <- do.call("rbind", list.tot.df.1984)
df_1984$cat.AI <- df_1984$cat.AI

sum_1984 <- df_1984 %>% group_by(lon,lat,Acronym) %>%  
                        dplyr::summarise(AI.avg = mean(AI, na.rm = T), AI.sd = sd(AI, na.rm = T),
                                        cat.AI.maj =  names(which.max(table(cat.AI, exclude = NULL))),
                                        agreement = str_count(string = cat.AI, pattern = cat.AI.maj)/11) %>% 
                      as.data.frame()
...
sum_1984$cat.AI.maj <- sum_1984$cat.AI.maj %>% factor() %>% ordered(cat.m)
