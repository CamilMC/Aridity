...
cmip6_01 <- mutate(read.table("cmip6/cmip6_january.txt"),
                   ...
                   pr_01 = pr*60*60*24, # mm/day
                   i_01 = (t_01/5)^1.514,
                   a_01 = (6.751e-7)*i_01^3 - (7.7e-5)*i_01^2 + 0.01729*i_01 + 0.49239,
                   e_01 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_01/i_01)^a_01 #Ep = 16 * L/12 * N/30 * (10T/I) ^a, L is length of daylight, N number of days in month
                   )                  
...
cmip6_02 <- mutate(read.table("cmip6/cmip6_february.txt"),
                   ...
                   pr_02 = pr*60*60*24, # mm/day
                   i_02 = (t_02/5)^1.514,
                   a_02 = (6.751e-7)*i_02^3 - (7.7e-5)*i_02^2 + 0.01729*i_02 + 0.49239,
                   e_02 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_02/i_02)^a_02 #Ep = 16 * L/12 * N/30 * (10T/I) ^a, L is length of daylight, N number of days in month
                   ) 
...
cmip6_03 <- mutate(read.table("cmip6/cmip6_march.txt"),
                   ...
                   pr_03 = pr*60*60*24, # mm/day
                   i_03 = (t_03/5)^1.514,
                   a_03 = (6.751e-7)*i_03^3 - (7.7e-5)*i_03^2 + 0.01729*i_03 + 0.49239,
                   e_03 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_03/i_03)^a_03 
                   ) 
...
cmip6_04 <- mutate(read.table("cmip6/cmip6_april.txt"),
                   ...
                   pr_04 = pr*60*60*24, # mm/day
                   i_04 = (t_04/5)^1.514,
                   a_04 = (6.751e-7)*i_04^3 - (7.7e-5)*i_04^2 + 0.01729*i_04 + 0.49239,
                   e_04 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_04/i_04)^a_04 
                   ) 
...
cmip6_05 <- mutate(read.table("cmip6/cmip6_may.txt"),
                   ...
                   pr_05 = pr*60*60*24, # mm/day
                   i_05 = (t_05/5)^1.514,
                   a_05 = (6.751e-7)*i_05^3 - (7.7e-5)*i_05^2 + 0.01729*i_05 + 0.49239,
                   e_05 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_05/i_05)^a_05 
                   ) 
...
cmip6_06 <- mutate(read.table("cmip6/cmip6_june.txt"),
                   ...
                   pr_06 = pr*60*60*24, # mm/day
                   i_06 = (t_06/5)^1.514,
                   a_06 = (6.751e-7)*i_06^3 - (7.7e-5)*i_06^2 + 0.01729*i_06 + 0.49239,
                   e_06 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_06/i_06)^a_06 
                   ) 
...
cmip6_07 <- mutate(read.table("cmip6/cmip6_july.txt"),
                   ...
                   pr_07 = pr*60*60*24, # mm/day
                   i_07 = (t_07/5)^1.514,
                   a_07 = (6.751e-7)*i_07^3 - (7.7e-5)*i_07^2 + 0.01729*i_07 + 0.49239,
                   e_07 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_07/i_07)^a_07 
                   ) 
...
cmip6_08 <- mutate(read.table("cmip6/cmip6_august.txt"),
                   ...
                   pr_08 = pr*60*60*24, # mm/day
                   i_08 = (t_08/5)^1.514,
                   a_08 = (6.751e-7)*i_08^3 - (7.7e-5)*i_08^2 + 0.01729*i_08 + 0.49239,
                   e_08 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_08/i_08)^a_08 
                   ) 
...
cmip6_09 <- mutate(read.table("cmip6/cmip6_september.txt"),
                   ...
                   pr_09 = pr*60*60*24, # mm/day
                   i_09 = (t_09/5)^1.514,
                   a_09 = (6.751e-7)*i_09^3 - (7.7e-5)*i_09^2 + 0.01729*i_09 + 0.49239,
                   e_09 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_09/i_09)^a_09 
                   ) 
...
cmip6_10 <- mutate(read.table("cmip6/cmip6_october.txt"),
                   ...
                   pr_10 = pr*60*60*24, # mm/day
                   i_10 = (t_10/5)^1.514,
                   a_10 = (6.751e-7)*i_10^3 - (7.7e-5)*i_10^2 + 0.01729*i_10 + 0.49239,
                   e_10 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_10/i_10)^a_10 
                   ) 
...
cmip6_11 <- mutate(read.table("cmip6/cmip6_november.txt"),
                   ...
                   pr_11 = pr*60*60*24, # mm/day
                   i_11 = (t_11/5)^1.514,
                   a_11 = (6.751e-7)*i_11^3 - (7.7e-5)*i_11^2 + 0.01729*i_11 + 0.49239,
                   e_11 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_11/i_11)^a_11 
                   ) 
...
cmip6_12 <- mutate(read.table("cmip6/cmip6_december.txt"),
                   ...
                   pr_12 = pr*60*60*24, # mm/day
                   i_12 = (t_12/5)^1.514,
                   a_12 = (6.751e-7)*i_12^3 - (7.7e-5)*i_12^2 + 0.01729*i_12 + 0.49239,
                   e_12 = 16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_12/i_12)^a_12 
                   ) 

cmip6.tho <- select(cmip6_01, c(id_vars, "t_01", "pr_01","i_01","a_01","e_01")) %>%
  merge(select(cmip6_02, c(id_vars, "t_02", "pr_02","i_02","a_02","e_02")), by = id_vars) %>%
  merge(select(cmip6_03, c(id_vars, "t_03", "pr_03","i_03","a_03","e_03")), by = id_vars) %>%
  merge(select(cmip6_04, c(id_vars, "t_04", "pr_04","i_04","a_04","e_04")), by = id_vars) %>%
  merge(select(cmip6_05, c(id_vars, "t_05", "pr_05","i_05","a_05","e_05")), by = id_vars) %>%
  merge(select(cmip6_06, c(id_vars, "t_06", "pr_06","i_06","a_06","e_06")), by = id_vars) %>%
  merge(select(cmip6_07, c(id_vars, "t_07", "pr_07","i_07","a_07","e_07")), by = id_vars) %>%
  merge(select(cmip6_08, c(id_vars, "t_08", "pr_08","i_08","a_08","e_08")), by = id_vars) %>%
  merge(select(cmip6_09, c(id_vars, "t_09", "pr_09","i_09","a_09","e_09")), by = id_vars) %>%
  merge(select(cmip6_10, c(id_vars, "t_10", "pr_10","i_10","a_10","e_10")), by = id_vars) %>%   
  merge(select(cmip6_11, c(id_vars, "t_11", "pr_11","i_11","a_11","e_11")), by = id_vars) %>%
  merge(select(cmip6_12, c(id_vars, "t_12", "pr_12","i_12","a_12","e_12")), by = id_vars) %>%
  mutate(I = i_01+i_02+i_03+i_04+i_05+i_06+i_07+i_08+i_09+i_10+i_11+i_12,
        ...
        pr = pr_01+pr_02+pr_03+pr_04+pr_05+pr_06+pr_07+pr_08+pr_09+pr_10+pr_11+pr_12,
        AI = pr/ET0)
...
# cmip6.tho <- mutate(cmip6.tho, i_01 = (tmean_01/5)^1.514,
...
# Maps AI UNESCO by model, all % calculated without Antarctica
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1850_1880" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "1850-1880", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1970_2000" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "1970-2000", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1985_2015" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "1985-2010", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP245" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP245" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP370" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP370-2030-thornthwaite}
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP370" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP585" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP585" & source == i)) + geom_raster(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
