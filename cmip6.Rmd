...
```{r map-historical-changes-percent, fig.dim = c(4,10)}
map_list <- list()
...
```{r map-historical-changes-quantiles-temperature, fig.dim = c(4,10)}
map_list <- list()
...
```{r map-historical-changes-quantiles-precipitation, fig.dim = c(4,10)}
map_list <- list()
