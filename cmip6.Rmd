...
```{r plot_point_changes, fig.dim = c(10,10), eval = F}
...
```{r plot-evolution-continent, fig.dim = c(10,10)}
...
```{r plot-evolution-subregion, fig.dim = c(10,40)}
...
```
```{r plot-evolution-temp-precip-continent, fig.dim = c(10,10)}
