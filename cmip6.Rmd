...
CMIP6 data is downloaded from https://aims2.llnl.gov/search 
...
```{r cmip6-data, eval = F}
tas.all_annual <- read.table("CMIP6_data/tas/tas.all_annual.txt")
pr.all_annual <- read.table("CMIP6_data/pr/pr.all_annual.txt")
sfcWind.all_annual <- read.table("CMIP6_data/sfcWind/sfcWind.all_annual.txt")
hfls.all_annual <- read.table("CMIP6_data/hfls/hfls.all_annual.txt")
hfss.all_annual <- read.table("CMIP6_data/hfss/hfss.all_annual.txt")
hurs.all_annual <- read.table("CMIP6_data/hurs/hurs.all_annual.txt")
...
write.table(cmip6_annual, "cmip6/cmip6_annual.txt")
```

```{r cmip6-january, eval = F}
tas.all_january <- read.table("CMIP6_data/tas/tas.all_january.txt")
pr.all_january <- read.table("CMIP6_data/pr/pr.all_january.txt")
sfcWind.all_january <- read.table("CMIP6_data/sfcWind/sfcWind.all_january.txt")
hfls.all_january <- read.table("CMIP6_data/hfls/hfls.all_january.txt")
hfss.all_january <- read.table("CMIP6_data/hfss/hfss.all_january.txt")
hurs.all_january <- read.table("CMIP6_data/hurs/hurs.all_january.txt")
...
write.table(cmip6_january, "cmip6/cmip6_january.txt")
```

```{r cmip6-february, eval = F}
tas.all_february <- read.table("CMIP6_data/tas/tas.all_february.txt")
pr.all_february <- read.table("CMIP6_data/pr/pr.all_february.txt")
sfcWind.all_february <- read.table("CMIP6_data/sfcWind/sfcWind.all_february.txt")
hfls.all_february <- read.table("CMIP6_data/hfls/hfls.all_february.txt")
hfss.all_february <- read.table("CMIP6_data/hfss/hfss.all_february.txt")
hurs.all_february <- read.table("CMIP6_data/hurs/hurs.all_february.txt")
...
write.table(cmip6_february, "cmip6/cmip6_february.txt")
```

```{r cmip6-march, eval = F}
tas.all_march <- read.table("CMIP6_data/tas/tas.all_march.txt")
pr.all_march <- read.table("CMIP6_data/pr/pr.all_march.txt")
sfcWind.all_march <- read.table("CMIP6_data/sfcWind/sfcWind.all_march.txt")
hfls.all_march <- read.table("CMIP6_data/hfls/hfls.all_march.txt")
hfss.all_march <- read.table("CMIP6_data/hfss/hfss.all_march.txt")
hurs.all_march <- read.table("CMIP6_data/hurs/hurs.all_march.txt")
...
write.table(cmip6_march, "cmip6/cmip6_march.txt")
```

```{r cmip6-april, eval = F}
tas.all_april <- read.table("CMIP6_data/tas/tas.all_april.txt")
pr.all_april <- read.table("CMIP6_data/pr/pr.all_april.txt")
sfcWind.all_april <- read.table("CMIP6_data/sfcWind/sfcWind.all_april.txt")
hfls.all_april <- read.table("CMIP6_data/hfls/hfls.all_april.txt")
hfss.all_april <- read.table("CMIP6_data/hfss/hfss.all_april.txt")
hurs.all_april <- read.table("CMIP6_data/hurs/hurs.all_april.txt")
...
write.table(cmip6_april, "cmip6/cmip6_april.txt")
```

```{r cmip6-may, eval = F}
tas.all_may <- read.table("CMIP6_data/tas/tas.all_may.txt")
pr.all_may <- read.table("CMIP6_data/pr/pr.all_may.txt")
sfcWind.all_may <- read.table("CMIP6_data/sfcWind/sfcWind.all_may.txt")
hfls.all_may <- read.table("CMIP6_data/hfls/hfls.all_may.txt")
hfss.all_may <- read.table("CMIP6_data/hfss/hfss.all_may.txt")
hurs.all_may <- read.table("CMIP6_data/hurs/hurs.all_may.txt")
...
write.table(cmip6_may, "cmip6/cmip6_may.txt")
```

```{r cmip6-june, eval = F}
tas.all_june <- read.table("CMIP6_data/tas/tas.all_june.txt")
pr.all_june <- read.table("CMIP6_data/pr/pr.all_june.txt")
sfcWind.all_june <- read.table("CMIP6_data/sfcWind/sfcWind.all_june.txt")
hfls.all_june <- read.table("CMIP6_data/hfls/hfls.all_june.txt")
hfss.all_june <- read.table("CMIP6_data/hfss/hfss.all_june.txt")
hurs.all_june <- read.table("CMIP6_data/hurs/hurs.all_june.txt")
...
write.table(cmip6_june, "cmip6/cmip6_june.txt")
```

```{r cmip6-july, eval = F}
tas.all_july <- read.table("CMIP6_data/tas/tas.all_july.txt")
pr.all_july <- read.table("CMIP6_data/pr/pr.all_july.txt")
sfcWind.all_july <- read.table("CMIP6_data/sfcWind/sfcWind.all_july.txt")
hfls.all_july <- read.table("CMIP6_data/hfls/hfls.all_july.txt")
hfss.all_july <- read.table("CMIP6_data/hfss/hfss.all_july.txt")
hurs.all_july <- read.table("CMIP6_data/hurs/hurs.all_july.txt")
...
write.table(cmip6_july, "cmip6/cmip6_july.txt")
```

```{r cmip6-august, eval = F}
tas.all_august <- read.table("CMIP6_data/tas/tas.all_august.txt")
pr.all_august <- read.table("CMIP6_data/pr/pr.all_august.txt")
sfcWind.all_august <- read.table("CMIP6_data/sfcWind/sfcWind.all_august.txt")
hfls.all_august <- read.table("CMIP6_data/hfls/hfls.all_august.txt")
hfss.all_august <- read.table("CMIP6_data/hfss/hfss.all_august.txt")
hurs.all_august <- read.table("CMIP6_data/hurs/hurs.all_august.txt")
...
write.table(cmip6_august, "cmip6/cmip6_august.txt")
```

```{r cmip6-september, eval = F}
tas.all_september <- read.table("CMIP6_data/tas/tas.all_september.txt")
pr.all_september <- read.table("CMIP6_data/pr/pr.all_september.txt")
sfcWind.all_september <- read.table("CMIP6_data/sfcWind/sfcWind.all_september.txt")
hfls.all_september <- read.table("CMIP6_data/hfls/hfls.all_september.txt")
hfss.all_september <- read.table("CMIP6_data/hfss/hfss.all_september.txt")
hurs.all_september <- read.table("CMIP6_data/hurs/hurs.all_september.txt")
...
write.table(cmip6_september, "cmip6/cmip6_september.txt")
```

```{r cmip6-october, eval = F}
tas.all_october <- read.table("CMIP6_data/tas/tas.all_october.txt")
pr.all_october <- read.table("CMIP6_data/pr/pr.all_october.txt")
sfcWind.all_october <- read.table("CMIP6_data/sfcWind/sfcWind.all_october.txt")
hfls.all_october <- read.table("CMIP6_data/hfls/hfls.all_october.txt")
hfss.all_october <- read.table("CMIP6_data/hfss/hfss.all_october.txt")
hurs.all_october <- read.table("CMIP6_data/hurs/hurs.all_october.txt")
...
write.table(cmip6_october, "cmip6/cmip6_october.txt")
```

```{r cmip6-november, eval = F}
tas.all_november <- read.table("CMIP6_data/tas/tas.all_november.txt")
pr.all_november <- read.table("CMIP6_data/pr/pr.all_november.txt")
sfcWind.all_november <- read.table("CMIP6_data/sfcWind/sfcWind.all_november.txt")
hfls.all_november <- read.table("CMIP6_data/hfls/hfls.all_november.txt")
hfss.all_november <- read.table("CMIP6_data/hfss/hfss.all_november.txt")
hurs.all_november <- read.table("CMIP6_data/hurs/hurs.all_november.txt")
...
write.table(cmip6_november, "cmip6/cmip6_november.txt")
```

```{r cmip6-december, eval = F}
tas.all_december <- read.table("CMIP6_data/tas/tas.all_december.txt")
pr.all_december <- read.table("CMIP6_data/pr/pr.all_december.txt")
sfcWind.all_december <- read.table("CMIP6_data/sfcWind/sfcWind.all_december.txt")
hfls.all_december <- read.table("CMIP6_data/hfls/hfls.all_december.txt")
hfss.all_december <- read.table("CMIP6_data/hfss/hfss.all_december.txt")
hurs.all_december <- read.table("CMIP6_data/hurs/hurs.all_december.txt")
...
write.table(cmip6_december, "cmip6/cmip6_december.txt")
```
...
```{r aridity-index-martonne, fig.dim = c(15, 20), cache = F}
cmip6 <- read.table("figures_article/cmip6.ref.txt") # created in "figures_article.Rmd", already converted in mm and °C
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "1970_2000" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AIm))+
...
cmip6_annual <- mutate(read.table("cmip6/cmip6_annual.txt"),
                       t = tas - 273.15,
...
cmip6_01 <- mutate(read.table("cmip6/cmip6_january.txt"),
                   t = tas - 273.15,
...
cmip6_02 <- mutate(read.table("cmip6/cmip6_february.txt"),
                   t = tas - 273.15,
...
cmip6_03 <- mutate(read.table("cmip6/cmip6_march.txt"),
                   t = tas - 273.15,
...
cmip6_04 <- mutate(read.table("cmip6/cmip6_april.txt"),
                   t = tas - 273.15,
...
cmip6_05 <- mutate(read.table("cmip6/cmip6_may.txt"),
                   t = tas - 273.15,
...
cmip6_06 <- mutate(read.table("cmip6/cmip6_june.txt"),
                   t = tas - 273.15,
...
cmip6_07 <- mutate(read.table("cmip6/cmip6_july.txt"),
                   t = tas - 273.15,
...
cmip6_08 <- mutate(read.table("cmip6/cmip6_august.txt"),
                   t = tas - 273.15,
...
cmip6_09 <- mutate(read.table("cmip6/cmip6_september.txt"),
                   t = tas - 273.15,
...
cmip6_10 <- mutate(read.table("cmip6/cmip6_october.txt"),
                   t = tas - 273.15,
...
cmip6_11 <- mutate(read.table("cmip6/cmip6_november.txt"),
                   t = tas - 273.15,
...
cmip6_12 <- mutate(read.table("cmip6/cmip6_december.txt"),
                   t = tas - 273.15,
...
write.table(cmip6, "cmip6/cmip6_AI.txt")
```


## AI Thornthwaite

```{r cmip6-ai-thornwaite, eval = F}
id_vars <- c("lon","lat","model","period","lm", "Continent","Type","Name","Acronym","source")
...
cmip6_01 <- mutate(read.table("cmip6/cmip6_january.txt"),
                   t_01 = tas - 273.15,
                   pr_01 = pr*60*60*24, # mm/day
                   i_01 = ifelse(t_01 >= 0, (t_01/5)^1.514, 0)
                   )                  

cmip6_02 <- mutate(read.table("cmip6/cmip6_february.txt"),
                   t_02 = tas - 273.15,
                   pr_02 = pr*60*60*24, # mm/day
                   i_02 = ifelse(t_02 >= 0, (t_02/5)^1.514, 0)
                   ) 

cmip6_03 <- mutate(read.table("cmip6/cmip6_march.txt"),
                   t_03 = tas - 273.15,
                   pr_03 = pr*60*60*24, # mm/day
                   i_03 = ifelse(t_03 >= 0, (t_03/5)^1.514, 0)
                   ) 

cmip6_04 <- mutate(read.table("cmip6/cmip6_april.txt"),
                   t_04 = tas - 273.15,
                   pr_04 = pr*60*60*24, # mm/day
                   i_04 = ifelse(t_04 >= 0, (t_04/5)^1.514, 0)
                   ) 

cmip6_05 <- mutate(read.table("cmip6/cmip6_may.txt"),
                   t_05 = tas - 273.15,
                   pr_05 = pr*60*60*24, # mm/day
                   i_05 = ifelse(t_05 >= 0, (t_05/5)^1.514, 0)
                   ) 

cmip6_06 <- mutate(read.table("cmip6/cmip6_june.txt"),
                   t_06 = tas - 273.15,
                   pr_06 = pr*60*60*24, # mm/day
                   i_06 = ifelse(t_06 >= 0, (t_06/5)^1.514, 0)
                   ) 

cmip6_07 <- mutate(read.table("cmip6/cmip6_july.txt"),
                   t_07 = tas - 273.15,
                   pr_07 = pr*60*60*24, # mm/day
                   i_07 = ifelse(t_07 >= 0, (t_07/5)^1.514, 0)
                   ) 

cmip6_08 <- mutate(read.table("cmip6/cmip6_august.txt"),
                   t_08 = tas - 273.15,
                   pr_08 = pr*60*60*24, # mm/day
                   i_08 = ifelse(t_08 >= 0, (t_08/5)^1.514, 0)
                   ) 

cmip6_09 <- mutate(read.table("cmip6/cmip6_september.txt"),
                   t_09 = tas - 273.15,
                   pr_09 = pr*60*60*24, # mm/day
                   i_09 = ifelse(t_09 >= 0, (t_09/5)^1.514, 0)
                   ) 

cmip6_10 <- mutate(read.table("cmip6/cmip6_october.txt"),
                   t_10 = tas - 273.15,
                   pr_10 = pr*60*60*24, # mm/day
                   i_10 = ifelse(t_10 >= 0, (t_10/5)^1.514, 0)
                   ) 

cmip6_11 <- mutate(read.table("cmip6/cmip6_november.txt"),
                   t_11 = tas - 273.15,
                   pr_11 = pr*60*60*24, # mm/day
                   i_11 = ifelse(t_11 >= 0, (t_11/5)^1.514, 0)
                   ) 

cmip6_12 <- mutate(read.table("cmip6/cmip6_december.txt"),
                   t_12 = tas - 273.15,
                   pr_12 = pr*60*60*24, # mm/day
                   i_12 = ifelse(t_12 >= 0, (t_12/5)^1.514, 0)
                   ) 

cmip6.tho <- select(cmip6_01, c(id_vars, "t_01", "pr_01","i_01")) %>%
  merge(select(cmip6_02, c(id_vars, "t_02", "pr_02","i_02")), by = id_vars) %>%
  merge(select(cmip6_03, c(id_vars, "t_03", "pr_03","i_03")), by = id_vars) %>%
  merge(select(cmip6_04, c(id_vars, "t_04", "pr_04","i_04")), by = id_vars) %>%
  merge(select(cmip6_05, c(id_vars, "t_05", "pr_05","i_05")), by = id_vars) %>%
  merge(select(cmip6_06, c(id_vars, "t_06", "pr_06","i_06")), by = id_vars) %>%
  merge(select(cmip6_07, c(id_vars, "t_07", "pr_07","i_07")), by = id_vars) %>%
  merge(select(cmip6_08, c(id_vars, "t_08", "pr_08","i_08")), by = id_vars) %>%
  merge(select(cmip6_09, c(id_vars, "t_09", "pr_09","i_09")), by = id_vars) %>%
  merge(select(cmip6_10, c(id_vars, "t_10", "pr_10","i_10")), by = id_vars) %>%   
  merge(select(cmip6_11, c(id_vars, "t_11", "pr_11","i_11")), by = id_vars) %>%
  merge(select(cmip6_12, c(id_vars, "t_12", "pr_12","i_12")), by = id_vars) %>%
  mutate(I = i_01+i_02+i_03+i_04+i_05+i_06+i_07+i_08+i_09+i_10+i_11+i_12,
          a = (6.751e-7)*I^3 - (7.7e-5)*I^2 + 0.01729*I + 0.49239,
        ET0_01 = ifelse(is.na(16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_01/I)^a) == T, 0,16* geosphere::daylength(lat,"2000-01-15")/12* 31 /30*(10*t_01/I)^a), #Ep = 16 * L/12 * N/30 * (10T/I) ^a, L is length of daylight, N number of days in month
        ET0_02 = ifelse(is.na(16* geosphere::daylength(lat,"2000-02-15")/12* 28 /30*(10*t_02/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-02-15")/12* 28 /30*(10*t_02/I)^a),
        ET0_03 = ifelse(is.na(16* geosphere::daylength(lat,"2000-03-15")/12* 31 /30*(10*t_03/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-03-15")/12* 31 /30*(10*t_03/I)^a),
        ET0_04 = ifelse(is.na(16* geosphere::daylength(lat,"2000-04-15")/12* 30 /30*(10*t_04/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-04-15")/12* 30 /30*(10*t_04/I)^a),
        ET0_05 = ifelse(is.na(16* geosphere::daylength(lat,"2000-05-15")/12* 31 /30*(10*t_05/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-05-15")/12* 31 /30*(10*t_05/I)^a),
        ET0_06 = ifelse(is.na(16* geosphere::daylength(lat,"2000-06-15")/12* 30 /30*(10*t_06/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-06-15")/12* 30 /30*(10*t_06/I)^a),
        ET0_07 = ifelse(is.na(16* geosphere::daylength(lat,"2000-07-15")/12* 31 /30*(10*t_07/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-07-15")/12* 31 /30*(10*t_07/I)^a),
        ET0_08 = ifelse(is.na(16* geosphere::daylength(lat,"2000-08-15")/12* 31 /30*(10*t_08/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-08-15")/12* 31 /30*(10*t_08/I)^a),
        ET0_09 = ifelse(is.na(16* geosphere::daylength(lat,"2000-09-15")/12* 30 /30*(10*t_09/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-09-15")/12* 30 /30*(10*t_09/I)^a),
        ET0_10 = ifelse(is.na(16* geosphere::daylength(lat,"2000-10-15")/12* 31 /30*(10*t_10/I)^a), 0, 16* geosphere::daylength(lat,"2000-10-15")/12* 31 /30*(10*t_10/I)^a),
        ET0_11 = ifelse(is.na(16* geosphere::daylength(lat,"2000-11-15")/12* 30 /30*(10*t_11/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-11-15")/12* 30 /30*(10*t_11/I)^a),
        ET0_12 = ifelse(is.na(16* geosphere::daylength(lat,"2000-12-15")/12* 31 /30*(10*t_12/I)^a) == T, 0, 16* geosphere::daylength(lat,"2000-12-15")/12* 31 /30*(10*t_12/I)^a),
        ET0 = ET0_01+ET0_02+ET0_03+ET0_04+ET0_05+ET0_06+ET0_07+ET0_08+ET0_09+ET0_10+ET0_11,ET0_12, # en mm
        pr = pr_01*31 + pr_02*28 + pr_03*31 + pr_04*30 + pr_05*31 + pr_06*30 + pr_07*31 + pr_08*31 + pr_09*30 + pr_10*31 + pr_11*30 + pr_12*31,
        AI = pr/ET0)

# cmip6.tho$ET0[is.na(cmip6.tho$ET0) == T] <- 0 #based on the assumption that ET0 is null when temperatures are negative
# cmip6.tho$AI <- with(cmip6.tho, pr/ET0)
...
cmip6.tho$cat.AI <- cmip6.tho$AI %>% cut(breaks = breaks.unesco) %>% revalue(cat.unesco)
cmip6.tho$cat.AI[which(cmip6.tho$ET0 < 400)] <- "Cold"
cmip6.tho$cat.AI %>% unique()

cmip6.tho$Tave <- rowMeans(cmip6.tho[,grep("t_",names(cmip6.tho))])

write.table(cmip6.tho, "cmip6/cmip6.tho.txt")
```



# Maps AI FAO by model, all % calculated without Antarctica

```{r read-data, cache = F}
cmip6 <- read.table("cmip6/cmip6_AI.txt")
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "1970_2000" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "1970-2000", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "1985_2015" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2030_2060" & model == "SSP245" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
...
sdmm <- cmip6 %>% subset(period == "2030_2060" & model == "SSP245" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2070_2100" & model == "SSP245" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
...
sdmm <- cmip6 %>% subset(period == "2070_2100" & model == "SSP245" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2030_2060" & model == "SSP370" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
sdmm <- cmip6 %>% subset(period == "2030_2060" & lat > -55& model == "SSP370" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2070_2100" & model == "SSP370" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
sdmm <- cmip6 %>% subset(period == "2070_2100" & model == "SSP370" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2030_2060" & model == "SSP585" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
sdmm <- cmip6 %>% subset(period == "2030_2060" & model == "SSP585" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
for(i in unique(cmip6$source)){
  g <- ggplot(data = subset(cmip6, period == "2070_2100" & model == "SSP585" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.translate = F)+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
sdmm <- cmip6 %>% subset(period == "2070_2100" & model == "SSP585" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
# Maps AI UNEP (Thornthwaite) by model, all % calculated without Antarctica

```{r read-data-thornthwaite, cache = F}
cmip6.tho <- read.table("cmip6/cmip6.tho.txt")

```

## 1850-1880

```{r maps-hist-1850-1880-thornthwaite, fig.dim = c(15, 20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1850_1880" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "1850-1880", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
}
...
```{r table-of-percent-1850-thornthwaite}

sdmm <- cmip6.tho %>% subset(period == "1850_1880"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
  t() %>% as.data.frame() %>% janitor::row_to_names(row_number = 1) %>% sapply(as.numeric) %>% as.data.frame() %>%
  mutate("Sum drylands" = rowSums(.[c("Hyperarid","Arid","Semi-arid","Dry subhumid")]), "source" = c("mean","sd")) %>%
  select(c("source","Hyperarid","Arid","Semi-arid","Dry subhumid","Sum drylands","Humid","Cold"))

tab <- cmip6.tho %>% subset(period == "1850_1880"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
knitr::kable(tab, digits = 2, escape = F)  %>%
  kable_styling(bootstrap_options = "bordered") %>% 
  column_spec(6, italic = T, include_thead = T) %>% row_spec(c(14,15), bold = T) 
```

## 1970-2000

```{r maps-hist-1970-2000-thornthwaite, fig.dim = c(15, 20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1970_2000" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "1970-2000", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r percent-of-each-class-by-by-source-thornthwaite, fig.dim = c(16,16)}
library(ggrepel) 

pie <- cmip6.tho %>% subset(period == "1970_2000" & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  select(c("source", "cat.AI")) %>%
  reshape2::melt(id.vars = c("source")) %>%
  group_by(source, value) %>%
  summarise(count = n()) %>%
...
```{r pie-multimodel-cmip6-thornthwaite}
pie <- cmip6.tho %>% subset(period == "1970_2000" & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  select(c("cat.AI")) %>%
  table(useNA = "ifany") %>% as.data.frame() %>%
  mutate(perc = round(Freq/sum(Freq)*100, 1),
   lab.y = rev(cumsum(rev(Freq))) - Freq*0.5) 
...
```{r table-of-percent-ref-thornthwaite}

sdmm <- cmip6.tho %>% subset(period == "1970_2000"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "1970_2000"   & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-hist-1985-2010-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "1985_2015" & source == i)) + 
    geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "1985-2010", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-1985-thornthwaite}

sdmm <- cmip6.tho %>% subset(period == "1985_2015"   & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "1985_2015"   & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp245-2030-2060-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP245" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP245-2030-thornthwaite}

sdmm <- cmip6.tho %>% subset(period == "2030_2060" & model == "SSP245" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2030_2060" & model == "SSP245"   & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp245-2070-2100-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP245" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, , na.value = "gray90")+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP245-2070-thornthwaite}
sdmm <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP245" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP245"   & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp370-2030-2060-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP370" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, , na.value = "gray90")+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP370-2030-thornthwaite, eval = F}
# as of now, not all categories are represented
sdmm <- cmip6.tho %>% subset(period == "2030_2060" & lat > -55 & model == "SSP370" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC")) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2030_2060" & model == "SSP370"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp370-2070-2100-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP370" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP370-2070-thornthwaite}
sdmm <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP370" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP370"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp585-2030-2060-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2030_2060" & model == "SSP585" & source == i)) + 
    geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "2030-2060", sep = ", "), fill = "")+
    theme_void()
...
```{r table-of-percent-SSP585-2030-thornthwaite}
sdmm <- cmip6.tho %>% subset(period == "2030_2060" & model == "SSP585" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2030_2060" & model == "SSP585"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
```{r maps-ssp585-2070-2100-thornthwaite, fig.dim = c(15,20)}
map_list <- list()

for(i in unique(cmip6.tho$source)){
  g <- ggplot(data = subset(cmip6.tho, period == "2070_2100" & model == "SSP585" & source == i)) + geom_tile(aes(x=lon, y = lat,  fill = cat.AI))+
    scale_fill_manual(values = col.cat, na.value = "gray90")+
    labs(title = paste(i, "2070-2100", sep = ", "), fill = "")+
    theme_void()
  map_list[[i]] <- g
...
```{r table-of-percent-SSP585-2070-thornthwaite}
sdmm <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP585" &!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  ungroup() %>% group_by(cat.AI) %>% summarise(mean = round(mean(percent, na.rm = T),1), sd = round(sd(percent, na.rm = T),1)) %>%
...
tab <- cmip6.tho %>% subset(period == "2070_2100" & model == "SSP585"  & !Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  group_by(source, cat.AI) %>%
  summarise(count = n()) %>%
  ungroup() %>% group_by(source) %>% mutate(percent = round(count/sum(count)*100, 1), count = NULL) %>%
  reshape2::dcast(source~cat.AI) %>%
...
knitr::kable(tab, digits = 2, escape = F)  %>%
  kable_styling(bootstrap_options = "bordered") %>% 
  column_spec(6, italic = T, include_thead = T) %>% row_spec(c(13,14), bold = T) 
```

# Multimodel average AI FAO
...
write.table(cmip6s, "cmip6/cmip6s.txt")

```

```{r read-cmip6s}
cmip6s <- read.table("cmip6/cmip6s.txt")
```
...
for(i in unique(cmip6s$model)){
  ...
  for(j in unique(df$period)){
    index <- paste(i, j, sep = "")
    g <- ggplot()+geom_tile(data = subset(df, period == j & same.catAI == "diff"), aes(x = lon, y = lat, fill = cat.AI))+
...
for(i in unique(cmip6s$model)){
  ...
  for(j in unique(df$period)){
    index <- paste(i, j, sep = "")
    g <- ggplot()+geom_tile(data = subset(df, period == j & same.catAI == "diff"), aes(x = lon, y = lat, fill = cat.maj))+
      borders(colour = "grey60")+
      scale_fill_manual(values =  col.cat, na.translate = F)+
      labs(title = paste(i, j , sep = " "), fill = "")+
      theme_void()+ylim(-55,90)+
...
ggpubr::ggarrange(plotlist = list(
  ...
  ggplot() + 
    geom_tile(data = subset(cmip6s, period == "1970_2000"), aes(x=lon, y = lat,  fill = cat.maj))+
  ...
  ggplot() + 
    geom_tile(data = subset(cmip6s, period == "1970_2000"), aes(x=lon, y = lat,  fill = cat.AI))+
   geom_point(data = subset(cmip6s, period == "1970_2000" & nb.maj > 10), aes(x =lon, y = lat), shape = "'", size = 0.5, col = "grey60")+
    scale_fill_manual(values = col.cat)+
...
for(i in c("1850_1880","1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = cat.maj))+
...
for(i in c("1850_1880","1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = cat.AI))+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = cat.maj))+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = cat.AI))+
    #     geom_point(data = subset(cmip6s, period == j & model == i & nb.maj > 10), aes(x= lon, y = lat), shape = "'", size = 0.5, col = "grey60")+
      scale_fill_manual(values = col.cat, na.translate = F)+
...
# Maps multimodel AI FAO 

```{r read-cmip6s-map-multimodel, eval = F}
...
for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = AI.mean))+
    borders(colour = "grey60")+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = AI.mean))+
      borders(colour = "grey60")+
      binned_scale(aesthetics = "fill", breaks = ai.breaks, palette = function(x) colscale,
                   guide = guide_legend(label.theme = element_text(angle = 0)))+
...
```{r map-historical-changes-quantiles-AI-cov, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = AI.sd/AI.mean))+
    ...
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
    labs(title = i, fill = "CoV Aridity index")+
    theme_void()+ylim(-55,90)+
    theme(legend.position = "right")
  map_list[[i]] <- g
}
...
```{r map-future-changes-quantiles-AI-cov, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = AI.sd/AI.mean))+
        geom_point(data = subset(cmip6s, period == i & model == i & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s,  period == i & model == i  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
      labs(fill = "CoV Aridity index", title = index)+
      theme_void()+ylim(-55,90)+
      theme(legend.position = "bottom")
    map_list[[index]] <- g
  }}
...
```{r map-historical-changes-quantiles-ET0-cov, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = ET0.sd/ET0))+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
    labs(title = i, fill = "CoV ET0")+
    theme_void()+ylim(-55,90)+
    theme(legend.position = "right")
  map_list[[i]] <- g
}
...
```{r map-future-changes-quantiles-ET0-cov, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = ET0.sd/ET0))+
      borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
      labs(fill = "CoV ET0", title = index)+
      theme_void()+ylim(-55,90)+
      theme(legend.position = "bottom")
    map_list[[index]] <- g
  }}
...
```{r map-historical-changes-quantiles-pr-cov, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = pr.sd/pr.mean))+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
    labs(title = i, fill = "CoV Precipitation")+
    theme_void()+ylim(-55,90)+
    theme(legend.position = "right")
  map_list[[i]] <- g
}
...
```{r map-future-changes-quantiles-pr-cov, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = pr.sd/pr.mean))+
      borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
      labs(fill = "CoV Precipitation", title = index)+
      theme_void()+ylim(-55,90)+
      theme(legend.position = "bottom")
    map_list[[index]] <- g
  }}
...
# Multimodel average AI Thornthwaite
...
```{r diff-AI-cmip6-tho, eval = T}
cmip6.tho <- read.table("cmip6/cmip6.tho.txt")

cmip6.tho.ref <- cmip6.tho %>% filter(period == "1970_2000") %>% select(c("lon","lat","model","period","source","AI","pr","Tave","ET0")) %>% setNames(c("lon","lat","model","period","source","AI.ref","pr.ref","Tave.ref","ET0.ref"))

cmip6.tho.ext <- merge(cmip6.tho, select(cmip6.tho.ref, c("lon","lat","source","AI.ref","pr.ref","Tave.ref","ET0.ref")) , by = c("lon","lat","source"), all = T) %>%  mutate(diff.AI = AI - AI.ref, diff.pr = pr - pr.ref, diff.t = Tave - Tave.ref, diff.ET0 = ET0 - ET0.ref)

write.table(cmip6.tho.ext, "cmip6/cmip6.tho.ext.txt")
```

Create a summary table with multimodel average. 

```{r agreement-between-models-thornthwaite, eval = F}
cmip6.tho.ext <- read.table("cmip6/cmip6ext.txt")
cmip6s.tho <- cmip6.tho.ext %>% 
  group_by(lon,lat,Continent, Type, Name, Acronym, lm, model, period) %>% 
  dplyr::summarise(t.mean = mean(Tave, na.rm = T), t.sd = sd(Tave, na.rm = T), # t in °C
                   pr.mean = mean(pr, na.rm = T) , pr.sd = sd(pr, na.rm = T),  # pr in mm/y
                   ET0 = mean(ET0, na.rm = T), et0.sd = sd(ET0, na.rm = T), # in mm/y
                   ET0.ref = mean(ET0.ref, na.rm = T), ET0.ref.sd = sd(ET0.ref, na.rm = T), # in mm/y
                   diff.ET0.mean = mean(diff.ET0, na.rm = T), diff.ET0.sd = sd(diff.ET0, na.rm = T),
                   AI.mean = mean(AI, na.rm = T), AI.sd = sd(AI, na.rm = T),
                   AI.med = median(AI, na.rm = T),
                   ...
                   diff.AI.mean = mean(diff.AI, na.rm = T), diff.AI.sd = sd(diff.AI, na.rm = T),
                   diff.AI.med = median(diff.AI, na.rm = T), 
                   pr.ref.mean = mean(pr.ref, na.rm = T), pr.ref.sd = sd(pr.ref, na.rm = T),
                   diff.pr.mean = mean(diff.pr, na.rm = T), diff.pr.sd = sd(diff.pr, na.rm = T),
                   t.ref.mean = mean(Tave.ref, na.rm = T), t.ref.sd = sd(Tave.ref, na.rm =T),
                   diff.t.mean = mean(diff.t, na.rm = T), diff.t.sd = sd(diff.t, na.rm = T),
                   Hyperarid = sum(cat.AI == "Hyperarid"),
                   Arid = sum(cat.AI == "Arid"),
                   'Semi-arid' = sum(cat.AI == "Semi-arid"),
...
cmip6s.tho$cat.AI <- cmip6s.tho$AI.mean %>% cut(breaks = breaks.unesco) %>% revalue(cat.unesco)
cmip6s.tho$cat.AI[which(cmip6s.tho$ET0 < 400)] <- "Cold"

cmip6s.tho$cat.maj <- colnames(select(cmip6s.tho, c("Hyperarid","Arid",'Semi-arid',"Dry subhumid",'Humid',"Cold","NA")))[max.col(select(cmip6s.tho, c("Hyperarid","Arid",'Semi-arid',"Dry subhumid",'Humid',"Cold","NA")),ties.method = "first")]
cmip6s.tho$nb.maj <- cmip6s.tho %>% select(c("Hyperarid","Arid",'Semi-arid',"Dry subhumid",'Humid',"Cold","NA")) %>% apply(1, max)
cmip6s.tho$prop.maj <- with(cmip6s.tho, nb.maj / nb.models)



cmip6s.tho$cat.AI.ref <- cmip6s.tho$AI.ref.mean %>% cut(breaks = breaks.unesco) %>% revalue(cat.unesco)
cmip6s.tho$cat.AI.ref[which(cmip6s.tho$ET0.ref < 400)] <- "Cold"

cmip6s.tho$cat.dryer <- with(cmip6s.tho, 
          ifelse(cat.AI.ref == "Arid" & cat.AI %in% c("Cold","Humid","Dry subhumid","Semi-arid"), "wetter", 
          ifelse(cat.AI.ref == "Arid" & cat.AI == "Hyperarid", "dryer",
          ifelse(cat.AI.ref == "Semi-arid" & cat.AI %in% c("Cold","Humid","Dry subhumid"), "wetter",
          ifelse(cat.AI.ref == "Semi-arid" & cat.AI %in% c("Hyperarid","Arid"), "dryer",
...
cmip6s.tho$Continent[which(cmip6s.tho$Continent == "EUROPE-AFRICA")] <- "MED-BASIN"

write.table(cmip6s.tho, "cmip6/cmip6s.tho.txt")

```

```{r read-cmip6s-tho, cache = F}
cmip6s.tho <- read.table("cmip6/cmip6s.tho.txt")
```

## Multimodel maps of cat mean

```{r map-historical-changes-AI-thornthwaite-catmean, fig.dim = c(3, 8)}

cmip6s.tho$cat.AI <- factor(cmip6s.tho$cat.AI, levels = c("Hyperarid","Arid","Semi-arid","Dry subhumid","Humid","Cold"))

map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + 
    geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = cat.AI))+
    geom_point(data = subset(cmip6s.tho,nb.maj > 10), aes(x = lon, y = lat), shape = ".", col = "grey20", size = 0.1)+
    borders(colour = "grey60")+
    scale_fill_manual(values =  col.cat, na.value = "gray90")+
    labs(title = paste("Category AI",i , sep = " "), fill = "")+
    theme_void()+ylim(-55,90)+
...
```{r map-future-categories-AI-tho, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + 
      geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = cat.AI))+
      geom_point(data = subset(cmip6s.tho,nb.maj > 10), aes(x = lon, y = lat), shape = ".", col = "grey20", size = 0.1)+
      borders(colour = "grey60")+
      scale_fill_manual(values =  col.cat, na.value = "gray90")+
      labs(title = paste("Category AI",index, sep = " "), fill = "")+
...
```{r map-historical-changes-AI-catmean-just-borders-tho, fig.dim = c(10, 6)}

cmip6s.tho$cat.AI <- factor(cmip6s.tho$cat.AI, levels = c("Hyperarid","Arid","Semi-arid","Dry subhumid","Humid","Cold"))

ggplot() + 
    geom_tile(data = subset(cmip6s.tho, period == "1970_2000" & model == "historical"), aes(x=lon, y = lat,  fill = cat.AI))+
    borders(colour = "grey60")+
    scale_fill_manual(values =  col.cat, na.translate = F)+
    labs(title = "Category AI 1970-2000", fill = "")+
    theme_void()+ylim(-55,90)+
...
ggplot() + 
    geom_tile(data = subset(cmip6s.tho, period == "2070_2100" & model == "SSP585"), aes(x=lon, y = lat,  fill = cat.AI))+
    borders(colour = "grey60")+
    scale_fill_manual(values =  col.cat, na.translate = F)+
    labs(title = "Category AI 2070-2100, SSP 585", fill = "")+
    theme_void()+ylim(-55,90)+
...
## Table of multimodel average category in percent, thornthwaite

```{r percent-categories-thornthwaite}
table.percent <- cmip6s.tho %>%  subset(!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
  select(period, model, cat.AI) %>% group_by(period, model, cat.AI) %>% summarise(count = n()) %>% 
  ungroup() %>% group_by(period, model) %>% mutate(percent = round(count/sum(count)*100,1))


ggplot(subset(table.percent, period == "1970_2000"), aes(x = cat.AI))+
  geom_col(aes(y = percent, fill = "mean"), position = position_nudge(x = - 0.2), width = 0.4)+
  scale_fill_manual(values = c("#ABD9E9", "#FDAE61"))+
  labs(x="Aridity category", fill = "Using mean or median")+
  theme_minimal()
...
# Maps multimodel AI Thornthwaite

```{r read-cmip6s-thornthwaite-map-multimodel, eval = F}

cmip6s.tho <- read.table("cmip6/cmip6s.tho.txt")

```

## Map AI thornthwaite mean

```{r aridity-index-thornthwaite}
quantile(cmip6s.tho$AI.mean, probs = seq(0,1,0.1), na.rm = T) 

ai.breaks <- c(0,0.03,0.2,0.5,0.65,1,10,20,30)
colscale <- brewer.pal(n = 11, name ="RdYlBu")[-c(5,6)]
```

```{r map-historical-changes-quantiles-AI-thornthwaite, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = AI.mean))+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = ai.breaks, palette = function(x) colscale,
                 guide = guide_legend(label.theme = element_text(angle = 0)))+
    labs(title = i, fill = "Aridity index")+
...
```{r map-future-changes-quantiles-AI-thornthwaite, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = AI.mean))+
      borders(colour = "grey60")+
      binned_scale(aesthetics = "fill", breaks = ai.breaks, palette = function(x) colscale,
                   guide = guide_legend(label.theme = element_text(angle = 0)))+
      labs(fill = "Aridity index", title = index)+
...
```{r map-historical-changes-quantiles-AI-thornthwaite-cov, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = AI.sd/AI.mean))+
              geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
    labs(title = i, fill = "CoV Aridity index")+
    theme_void()+ylim(-55,90)+
...
```{r map-future-changes-quantiles-AI-thornthwaite-cov, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = AI.sd/AI.mean))+
        geom_point(data = subset(cmip6s.tho, period == i & model == i & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == i & model == i  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
      labs(fill = "CoV Aridity index", title = index)+
      theme_void()+ylim(-55,90)+
...
```{r map-historical-changes-quantiles-ET0-thornthwaite-cov, fig.dim = c(5,10)}
map_list <- list()

for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = et0.sd/ET0))+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
    labs(title = i, fill = "CoV ET0")+
    theme_void()+ylim(-55,90)+
...
```{r map-future-changes-quantiles-ET0-thornthwaite-cov, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = et0.sd/ET0))+
      borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks = c(0.3,0.5,1), palette = function(x) c( "#6baed6","#c6dbef", "#fddbc7", "#d6604d"))+
      labs(fill = "CoV ET0", title = index)+
      theme_void()+ylim(-55,90)+
...
# Comparison multimodel PM and Thornthwaite

```{r maps-comparison}
pm.tho <- merge(
  select(filter(cmip6s, period == "1970_2000"), c("lon","lat","ET0","AI.mean")),
  select(filter(cmip6s.tho, period == "1970_2000"), c("lon","lat","ET0","AI.mean")),
  by = c("lon","lat")
)


ggplot(pm.tho) + geom_tile(aes(x=lon, y = lat,  fill = ET0.x - ET0.y))+
    borders(colour = "grey60")+
    binned_scale(aesthetics = "fill", breaks =  c(-500,-250,0,250,500,750,1000), palette = function(x) colscale,
                 guide = guide_legend(label.theme = element_text(angle = 0)))+
    labs(title = i, fill = "Aridity index")+
    theme_void()+ylim(-55,90)+
    theme(legend.position = "right")
...
# AI changes over time and scenarios, FAO
...
for(i in c("1850_1880","1985_2015")){
  ...
  b = qbreaks
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = diff.AI.mean))+
    borders(colour = "grey60")+
           geom_point(data = subset(cmip6s, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    b = qbreaks
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = diff.AI.mean))+
      borders(colour = "grey60")+
                 geom_point(data = subset(cmip6s, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale),
...
for(i in c("1850_1880","1985_2015")){
  ...
  #b = quant[1,c(3:7)] %>% as.numeric
  b = pbreaks
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = diff.AI.mean.percent))+
    borders(colour = "grey60")+
           geom_point(data = subset(cmip6s, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
    binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale))+
...
# AI changes over time and scenarios, Thornthwaite

## Changes AI for summary CMIP6

## Boxplot of changes AI

```{r boxplot-diff-tho, fig.dim = c(8,5)}
ggpubr::ggarrange(plotlist = list(
  ggplot(subset(cmip6s.tho, diff.AI.mean < 1 & diff.AI.mean > -1 & model == "historical"))+
    geom_boxplot(aes(x=period, y = - diff.AI.mean, col = period), outliers = F)+
    scale_color_manual(values = c("#D73027","#FDAE61","#FEE08B"))+
    labs(x = "", y = "Difference of AI between each period and\nthe reference period 1970-2000")+
    facet_grid(cols = vars(model))+
...
```{r map-plusminus-tho, fig.dim = c(10,10)}
map_list <- list()
...
for(i in c("SSP245","SSP370","SSP585")){
  ...
  index <- paste(i, j, sep = ", ")
  g <- ggplot()+
  geom_point(data = subset(cmip6s.tho, model == i & period == j & plus.AI > 10), aes(x = lon, y = lat, col = "plus"), shape = "+")+
  geom_point(data = subset(cmip6s.tho, model == i & period == j & minus.AI > 10), aes(x = lon, y = lat, col = "minus"), shape = "-")+
    scale_color_manual(values = c("#ABD9E9", "#D73027"))+
    labs(color = "", x = "", y = "", title = index)+
  theme_minimal()
  map_list[[index]] <- g
...
```{r map-historical-changes-strict-tho, fig.dim = c(8,3)}
map_list <- list()

for(i in c("1850_1880","1985_2015")){
    index <- paste(i, j, sep = " , ")
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical" & diff.AI.mean > 0), aes(x=lon, y = lat,  fill = "wetter"))+
    geom_tile(data = subset(cmip6s.tho, period == i & model == "historical" & diff.AI.mean < 0), aes(x=lon, y = lat,  fill = "dryer"))+
    geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", size = 0.5)+
     geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & minus.AI > 10), aes(x=lon, y = lat), shape = "-", size = 0.5)+
    borders(colour = "grey60")+
    scale_fill_manual(values =  c("#FDAE61", "#ABD9E9"), na.translate = F)+
    labs(title = paste("AI changes between",i , "and 1970-2000", sep = " "), fill = "")+
    theme_void()+ylim(-55,90)+
...
```{r map-future-changes-strict-tho, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i & diff.AI.mean > 0), aes(x=lon, y = lat,  fill = "wetter"))+
      geom_tile(data = subset(cmip6s.tho, period == j & model == i & diff.AI.mean < 0), aes(x=lon, y = lat,  fill = "dryer"))+
       geom_point(data = subset(cmip6s.tho, period == j & model == i & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho, period == j & model == i & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      borders(colour = "grey60")+
      scale_fill_manual(values = c("#F46D43", "#74ADD1"), na.translate = F)+
      labs(fill = "Compared to 1970-2000", title = i)+
      theme_void()+ylim(-55,90)+
...
```{r summary-of-AI-changes-tho}
ano.quantiles <- cmip6s.tho %>% group_by(model, period) %>% summarise(q10 = quantile(diff.AI.mean, probs = 0.1, na.rm =T), 
                                                                  q25 = quantile(diff.AI.mean, probs = 0.25, na.rm =T), 
                                                                  q50 = quantile(diff.AI.mean, probs = 0.5, na.rm =T), 
                                                                  q75 = quantile(diff.AI.mean, probs = 0.75, na.rm =T), 
                                                                  q90 = quantile(diff.AI.mean, probs = 0.9, na.rm =T)) 

ano.quantiles <- cmip6s.tho %>% summarise(q10 = quantile(diff.AI.mean, probs = 0.1, na.rm =T), 
                                      q25 = quantile(diff.AI.mean, probs = 0.25, na.rm =T), 
                                      q50 = quantile(diff.AI.mean, probs = 0.5, na.rm =T), 
                                      q75 = quantile(diff.AI.mean, probs = 0.75, na.rm =T), 
                                      q90 = quantile(diff.AI.mean, probs = 0.9, na.rm =T)) 
...
```{r map-historical-changes-quantiles-tho, fig.dim = c(8,3)}
map_list <- list()
...
for(i in c("1850_1880","1985_2015")){
  ...
  #b = quant[1,c(3:7)] %>% as.numeric
  b = qbreaks
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = diff.AI.mean))+
    borders(colour = "grey60")+
           geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
    binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale),
...
```{r map-future-changes-quantiles-tho, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    b = qbreaks
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = diff.AI.mean))+
      borders(colour = "grey60")+
                 geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale),
...
```{r summary-of-AI-changes-percent-tho}
cmip6s.tho$diff.AI.mean.percent <- with(cmip6s.tho, (AI.mean-AI.ref.mean)/AI.ref.mean*100)
...
```{r map-historical-changes-percent-tho, fig.dim = c(8,3)}
map_list <- list()
...
for(i in c("1850_1880","1985_2015")){
  ...
  #b = quant[1,c(3:7)] %>% as.numeric
  b = pbreaks
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"), aes(x=lon, y = lat,  fill = diff.AI.mean.percent))+
    borders(colour = "grey60")+
           geom_point(data = subset(cmip6s.tho, period == i & model == "historical" & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == i & model == "historical"  & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
    binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale))+
...
```{r map-future-changes-percent-tho, fig.dim = c(15,15)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    b = pbreaks
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i), aes(x=lon, y = lat,  fill = diff.AI.mean.percent))+
      borders(colour = "grey60", size = 0.5)+
                 geom_point(data = subset(cmip6s.tho, period == j & model == i & plus.AI > 10), aes(x=lon, y = lat), shape = "+", col = "grey20", size = 0.5)+
       geom_point(data = subset(cmip6s.tho,  period == j & model == i & minus.AI > 10), aes(x=lon, y = lat), shape = "-", col = "grey20", size = 0.5)+
      binned_scale(aesthetics = "fill", breaks = b, palette = function(x) rev(colscale))+
...
# Map of difference between future and reference category of AI, FAO (cat.mean)
...
for(i in c("1850_1880","1985_2015")){
  g <- ggplot() + 
    geom_tile(data = subset(cmip6s, period == i & model == "historical" & change.catmean == 1 & cat.dryer == "dryer"), 
...
for(i in unique(cmip6s$model)){
g <- ggplot() + 
  geom_tile(data = subset(cmip6s, period == "2070_2100" & model == i & change.catmean == 1), aes(x=lon, y = lat,  fill = change.cat.mean))+
      borders(colour = "grey60")+
      scale_fill_manual(values = colors_changes, na.translate = F)+
      labs(fill = paste("Change of aridity category\nfor the period 2070-2100\nand ", i,"\ncompared to 1970-2000", sep = ""), title = "")+
      theme_void()+ylim(-55,90)+
...
# Map of difference between future and reference category of AI, Thornthwaite 

## Detailed changes and colors 

```{r detailed-cat-mean-change-tho}
cmip6s.tho$change.catmean <- with(cmip6s.tho, ifelse(cat.AI == cat.AI.ref, 0, 1))

cmip6s.tho$change.cat.mean <- with(cmip6s.tho, paste(cat.AI.ref, cat.AI, sep = " to "))
unique(cmip6s.tho$change.cat.mean)

table(cmip6s.tho$change.cat.mean)
cmip6s.tho$change.cat.mean <- factor(cmip6s.tho$change.cat.mean, 
                                  levels = c("Hyperarid to Arid",
                                             "Arid to Semi-arid",
                                             "Semi-arid to Dry subhumid",
                                             "Dry subhumid to Humid",
...
```{r map-historical-changes-dry-catmean-tho, fig.dim = c(8,3)}
map_list <- list()

for(i in c("1850_1880","1985_2015")){
  g <- ggplot() + 
    geom_tile(data = subset(cmip6s.tho, period == i & model == "historical" & change.catmean == 1 & cat.dryer == "dryer"), 
                aes(x=lon, y = lat,  fill = change.cat.mean))+
    borders(colour = "grey60")+
    scale_fill_manual(values =  colors_changes, na.translate = F)+
    labs(title = i, fill = "Change of category\ncompared to\n1970-2000")+
...
```{r map-future-changes-dry-catmean-tho, fig.dim = c(10,10)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i & change.catmean == 1 & cat.dryer == "dryer"), 
                              aes(x=lon, y = lat,  fill = change.cat.mean))+
      borders(colour = "grey60")+
      scale_fill_manual(values = colors_changes)+
      labs(fill = "Change of category\ncompared to\n1970-2000", title = index)+
...
```{r map-historical-changes-wet-tho, fig.dim = c(8, 2)}
map_list <- list()

for(i in c("1850_1880","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == i & model == "historical"  & cat.dryer == "wetter"), 
                            aes(x=lon, y = lat,  fill = change.cat.mean))+
    borders(colour = "grey60", ylim = c(-40,40))+
    scale_fill_manual(values =  colors_changes, na.translate = F)+
    labs(title = i, fill = "Change of category\ncompared to\n1970-2000")+
...
```{r map-future-changes-wet-catmean-tho, fig.dim = c(10,8)}
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s.tho, period == j & model == i & change.catmean == 1 & cat.dryer == "wetter"), 
                              aes(x=lon, y = lat,  fill = change.cat.mean))+
      borders(colour = "grey60", ylim = c(-40,40))+
      scale_fill_manual(values = colors_changes, na.translate = F)+
      labs(fill = "Change of category\ncompared to\n1970-2000", title = index)+
...
```{r bigmap-tho, fig.dim = c(10,7)}

for(i in unique(cmip6s.tho$model)){
g <- ggplot() + 
  geom_tile(data = subset(cmip6s.tho, period == "2070_2100" & model == i & change.catmean == 1), aes(x=lon, y = lat,  fill = change.cat.mean))+
      borders(colour = "grey60")+
      scale_fill_manual(values = colors_changes, na.translate = F)+
      labs(fill = paste("Change of aridity category\nfor the period 2070-2100\nand ", i,"\ncompared to 1970-2000", sep = ""), title = "")+
      theme_void()+ylim(-55,90)+
...
```{r changes-in-table}
tab.future <- cmip6 %>% subset(!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
...
write.table(tab.percent, "cmip6/tab.percent.txt")
```

```{r colplots-futurecatmean, fig.dim = c(10,5)}
tab.percent <- read.table("cmip6/tab.percent.txt")
...
tab.future.maj <- cmip6s %>% subset(!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55) %>%
...
cmip6$cat.AI <- factor(cmip6$cat.AI, levels = c("Hyperarid", "Arid", "Semi-arid", "Dry subhumid", "Humid", "Cold") & lat > -55)
...
tab.percent.cont <- cmip6 %>% subset(!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC") & lat > -55 ) %>%
  ...
  summarise(mmmean = mean(count, na.rm = T), mmsd = sd(count, na.rm = T)) %>%
  mutate(percent = round(mmmean/sum(mmmean)*100, 1), sd.percent = round(mmsd/sum(mmmean)*100,1)) 
write.table(tab.percent.cont, "cmip6/tab.percent.continent.txt")
```

```{r changes-in-table-by-continent-mean, results = "asis"}
tab.percent.cont <- read.table("cmip6/tab.percent.continent.txt")
...
write.table(tab.cont.diff, "cmip6/tab.cont.diff.txt")

```

```{r changes-in-table-by-continent-diff, results = "asis"}
tab.cont.diff <- read.table("cmip6/tab.cont.diff.txt")
...
# Changes in proportion of aridity categories (FAO), figure
...
# Evolution of aridity index (FAO) by Continent and period
...
## Point figure, all models

```{r read-cmip6, eval = T}
cmip6 <- read.table("cmip6/cmip6ext.txt")
```

```{r mean-and-sd-by-continent-by-model-by-period-by-ssp}
cmip6$diff.AI.percent <- with(cmip6, diff.AI/AI.ref *100)

tab.cmip6.continent <- cmip6 %>% subset(!Continent %in% c("SOUTHERN","PACIFIC","ATLANTIC","INDIAN","ARCTIC","POLAR","NA") & lat > -55 & !period %in% c("1850_1880","1985_2015")) %>%
  group_by(period, source, model, Continent) %>% select(c("diff.AI.percent")) %>%
  summarise(AI.diff.mean = mean(diff.AI.percent, na.rm = T), AI.diff.sd= sd(diff.AI.percent, na.rm = T), AI.diff.cv = AI.diff.sd/abs(AI.diff.mean)) %>%
  ungroup()


ref <- tab.cmip6.continent[which(tab.cmip6.continent$model == "historical"),]
ref1 <- ref %>% mutate(model = "SSP245")
ref2 <- ref %>% mutate(model = "SSP370")
ref3 <- ref %>% mutate(model = "SSP585")

tab.for.plot <- rbind(subset(tab.cmip6.continent, model != "historical"), ref1) %>% rbind(ref2) %>% rbind(ref3)  

tab.for.plot$Continent[which(tab.for.plot$Continent == "EUROPE-AFRICA")] <- "MED-BASIN"
tab.for.plot$Continent <- str_replace(tab.for.plot$Continent, "-", "\n")
tab.for.plot$Continent <- factor(tab.for.plot$Continent, levels = c("NORTH\nAMERICA", "CENTRAL\nAMERICA", "SOUTH\nAMERICA", "EUROPE", "MED\nBASIN", "AFRICA", "ASIA", "OCEANIA"))


tab.for.plot$model[which(tab.for.plot$model == "SSP245")] <- "SSP 2-4.5"
tab.for.plot$model[which(tab.for.plot$model == "SSP370")] <- "SSP 3-7.0"
tab.for.plot$model[which(tab.for.plot$model == "SSP585")] <- "SSP 5-8.5"

tab.for.plot$period[which(tab.for.plot$period == "1970_2000")] <- "1970-2000"
tab.for.plot$period[which(tab.for.plot$period == "2030_2060")] <- "2030-2060"
tab.for.plot$period[which(tab.for.plot$period == "2070_2100")] <- "2070-2100"

ggplot(tab.for.plot, aes(x = period, y = AI.diff.mean))+
  geom_point(aes(size = AI.diff.cv, col = source), alpha = 0.5)+
  geom_line(aes(group = source, col = source), size = 0.1, alpha = 0.5)+
  facet_grid(rows = vars(model), cols = vars(Continent))+
  scale_size_continuous(breaks = c(0,1,5,10,100), transform = "pseudo_log")+
  # scale_color_gradient(low = "gray", high = "#D73027", breaks = c(0,1,5,10,100), transform = "pseudo_log")+
...
for(i in unique(tab.for.plot$source)){
  
g <- ggplot(filter(tab.for.plot, source == i), aes(x = period, y = AI.diff.mean))+
  geom_point(aes(size = AI.diff.cv, col = AI.diff.cv))+
  geom_line(aes(group = Continent), size = 0.1)+
  facet_grid(rows = vars(model), cols = vars(Continent))+
  scale_size_continuous(breaks = c(0,1,5,10,100), transform = "pseudo_log")+
...
for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = t.mean))+
    borders(colour = "grey60")+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = t.mean))+
      borders(colour = "grey60")+
      binned_scale(aesthetics = "fill", breaks = t.breaks, palette = function(x) colscale,
                   guide = guide_legend(label.theme = element_text(angle = 0)))+
...
for(i in c("1850_1880", "1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = diff.t.mean))+
    borders(colour = "grey60")+
...
for(i in c("1850_1880","1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = pr.mean))+
    borders(colour = "grey60")+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = pr.mean))+
      borders(colour = "grey60")+
      binned_scale(aesthetics = "fill", breaks = p.breaks, palette = function(x) rev(colscale),
                   guide = guide_legend(label.theme = element_text(angle = 0)))+
...
for(i in c("1850_1880","1970_2000","1985_2015")){
  g <- ggplot() + geom_tile(data = subset(cmip6s, period == i & model == "historical"), aes(x=lon, y = lat,  fill = pr.percent))+
    borders(colour = "grey60")+
...
for(i in c("SSP245","SSP370","SSP585")){
  for (j in c("2030_2060","2070_2100")){
    index <- paste(i, j, sep = " , ")
    g <- ggplot() + geom_tile(data = subset(cmip6s, period == j & model == i), aes(x=lon, y = lat,  fill = pr.percent))+
      borders(colour = "grey60")+
   scale_fill_gradient2(high = "#08519c", mid = "white", low = "#b2182b", midpoint = 0, transform = "pseudo_log", breaks = c(-10, -5, -1, 0, 1, 5, 10, 15, 30))+
...
# Export cmip6s for github

```{r export-cmip6s}
cmip6s_github <- cmip6s %>% select(c("lon","lat","Continent","Name","Acronym","model","period","z","t.mean","t.sd","pr.mean","pr.sd","sfcWind.mean","sfcWind.sd","ET0","ET0.sd","AI.mean","AI.sd","cat.maj"))

write.table(cmip6s_github , "cmip6/cmip6s_github.txt")
``` 
...
cmip6monthly <- read.table("cmip6/cmip6monthly.txt")
...
cmip6smonthly$Continent[which(cmip6s$Continent == "EUROPE-AFRICA")] <- "MED-BASIN"

write.table(cmip6smonthly, "cmip6/cmip6smonthly.txt")
```

```{r map-AI-monthly, fig.dim = c(16,16)}
cmip6smonthly <- read.table("cmip6/cmip6smonthly.txt")
...
g <- ggplot(subset(cmip6sml, Continent == i & period %in% c("1970_2000","2070_2100")))+
  ...
  geom_point(aes(x=Month, y = AI, size = cov_AI, col = model), alpha = 0.8)+
  geom_line(aes(x=Month, y = AI, col = model, group = model, linetype = model), alpha = 0.8)+
...
g <- ggplot(subset(cmip6sml_et0, Continent == i & period %in% c("1970_2000","2070_2100")))+
  ...
  # geom_rect(aes(xmin = 1, xmax = 12, ymin= 0.5, ymax = 0.65), fill = "#ABD9E9", alpha = 0.02)+
  # geom_rect(aes(xmin = 1, xmax = 12, ymin= 0.65, ymax = Inf), fill = "#4575B4", alpha = 0.02)+
  geom_point(aes(x=Month, y = ET0, size = cov_ET0, col = model), alpha = 0.8)+
  geom_line(aes(x=Month, y = ET0, col = model, group = model, linetype = model), alpha = 0.8)+
  scale_color_manual(values = col.model)+
  scale_size_continuous(transform = "pseudo_log")+
...
g <- ggplot(subset(cmip6sml_pr, Continent == i & period %in% c("1970_2000","2070_2100")))+
  ...
  # geom_rect(aes(xmin = 1, xmax = 12, ymin= 0.5, ymax = 0.65), fill = "#ABD9E9", alpha = 0.02)+
  # geom_rect(aes(xmin = 1, xmax = 12, ymin= 0.65, ymax = Inf), fill = "#4575B4", alpha = 0.02)+
  geom_point(aes(x=Month, y = pr, size = cov_pr, col = model), alpha = 0.8)+
  geom_line(aes(x=Month, y = pr, col = model, group = model, linetype = model), alpha = 0.8)+
  scale_color_manual(values = col.model)+
  scale_size_continuous(transform = "pseudo_log")+
...
```
# SPEI on 30-years average precipitation and ET0

```{r spei}
library(SPEI)

spei_test <- cmip6 %>% select(c("lon","lat","source","model","period",
    "pr_01","pr_02","pr_03","pr_04","pr_05","pr_06","pr_07","pr_08","pr_09","pr_10","pr_11","pr_12",
    "ET0_01","ET0_02","ET0_03","ET0_04","ET0_05","ET0_06","ET0_07","ET0_08","ET0_09","ET0_10","ET0_11","ET0_12")) %>%
    filter(period == "1970_2000")


vec1 <- spei_test[1000,]
  
pr_col <- grep("pr",names(vec1), value = T)
ET0_col <- grep("ET0",names(vec1), value = T)


wb <- as.numeric(vec1[,pr_col]) - as.numeric(vec1[,ET0_col])
extended_wb <- rep(wb,2)
spei_result <- spei(data = extended_wb, scale = 3)

spei_result$fitted

spi(as.numeric(vec1[,pr_col]), scale = 3)
